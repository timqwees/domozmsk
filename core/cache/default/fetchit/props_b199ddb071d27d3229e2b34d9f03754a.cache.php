<?php if(time() > 1789464791){return null;} return array (
  ...
  'emailSubject' => 'Заявка с модального окна - Как подготовить автополив к зиме: пошаговая инструкция по консервации | Дом Оз',
