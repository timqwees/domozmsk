<?php if(time() > 1789452009){return null;} return array (
...
',
    ...
    array (
      0 => 'the_link',
      1 => 'https://domozmsk.ru/uslugi/topographic-survey/',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
      ...
      1 => '[
  {
    ...
    "items": [
      {
        "name": "Консультация специалиста по телефону",
        "price": "Бесплатно",
        "unit": "услуга"
      },
      {
        "name": "Топографическая съемка участка",
        "price": "от 12 000 ₽",
        "unit": "услуга"
      }
    ]
    ...
    array (
      0 => 'service_photos',
      1 => '[{"MIGX_id":"1","img":"assets\\/img\\/\\u0444\\u043e\\u0442\\u043e_\\u0442\\u043e\\u043f\\u043e\\u0433\\u0440\\u0430\\u0444\\u0438\\u0447\\u0435\\u0441\\u043a\\u0430\\u044f_\\u0441\\u044a\\u0435\\u043c\\u043a\\u0430\\/\\u0444\\u043e\\u0442\\u043a\\u0438\\/03.png"},{"MIGX_id":"2","img":"assets\\/img\\/\\u0444\\u043e\\u0442\\u043e_\\u0442\\u043e\\u043f\\u043e\\u0433\\u0440\\u0430\\u0444\\u0438\\u0447\\u0435\\u0441\\u043a\\u0430\\u044f_\\u0441\\u044a\\u0435\\u043c\\u043a\\u0430\\/\\u0444\\u043e\\u0442\\u043a\\u0438\\/01.jpg"},{"MIGX_id":"3","img":"assets\\/img\\/\\u0444\\u043e\\u0442\\u043e_\\u0442\\u043e\\u043f\\u043e\\u0433\\u0440\\u0430\\u0444\\u0438\\u0447\\u0435\\u0441\\u043a\\u0430\\u044f_\\u0441\\u044a\\u0435\\u043c\\u043a\\u0430\\/\\u0444\\u043e\\u0442\\u043a\\u0438\\/04.jpg"}]',
      2 => 'default',
      3 => NULL,
      4 => 'migx',
    ),
    ...
    array (
      0 => 'img_cat',
      1 => 'assets/img/фото_топографическая_съемка/фотки/03.png',
      2 => 'default',
      3 => NULL,
      4 => 'image',
    ),
    ...
    array (
      0 => 'fy_block',
      1 => '<h2>причины сделать топоснимок в DOM OZ</h2>

<div class="fy_grid">
<div class="fy_grid-block">
<h4>Комплексный подход</h4>

<p>Один подрядчик отвечает за все этапы — от геодезических работ до проектирования и благоустройства участка.</p>
</div>

<div class="fy_grid-block">
<h4>Готовая картография участка</h4>

<p>Клиент получает документ, соответствующий государственным нормам и пригодный для согласования в инстанциях</p>
</div>

<div class="fy_grid-block">
<h4>Качественно и быстро</h4>

<p>В короткий срок вы получите готовые геодезические данные, пригодных для проектирования и строительства</p>
</div>

<div class="fy_grid-block">
<h4>Консультация</h4>

<p>Вы получите ответы на все интересующие вопросы в день подачи заявки</p>
</div>
</div>
',
      2 => 'default',
    ...
    array (
      0 => 'baner_img',
      1 => '[{"MIGX_id":"2","img":"assets\\/img\\/\\u0444\\u043e\\u0442\\u043e_\\u0442\\u043e\\u043f\\u043e\\u0433\\u0440\\u0430\\u0444\\u0438\\u0447\\u0435\\u0441\\u043a\\u0430\\u044f_\\u0441\\u044a\\u0435\\u043c\\u043a\\u0430\\/background.jpg","img_mob":"assets\\/img\\/\\u0444\\u043e\\u0442\\u043e_\\u0442\\u043e\\u043f\\u043e\\u0433\\u0440\\u0430\\u0444\\u0438\\u0447\\u0435\\u0441\\u043a\\u0430\\u044f_\\u0441\\u044a\\u0435\\u043c\\u043a\\u0430\\/background.jpg"}]',
      2 => 'default',
      3 => NULL,
      4 => 'migx',
    ),
    ...
    array (
      0 => 'baner_des',
      1 => 'Планируете строительство дома, благоустройство территории или подключение коммуникаций? Выполним топографическую съемку участка с высокой точностью и подготовим официальный топографический план для проектирования, получения разрешений и проведения строительных работ. Работаем оперативно, используем современное геодезическое оборудование и гарантируем соответствие результатов действующим нормативным требованиям.',
      2 => 'default',
      3 => NULL,
      4 => 'richtext',
    ),
...
{/ignore}
    ...
    '_jscripts' => 
    array (
      0 => '<script>window.addEventListener(\'DOMContentLoaded\', () => FetchIt.create({"action":"070cab3b8f0acaa298be32e93ae6d8fe","assetsUrl":"\\/assets\\/components\\/fetchit\\/","actionUrl":"\\/assets\\/components\\/fetchit\\/action.php","inputInvalidClass":"is-invalid","customInvalidClass":"","clearFieldsOnSuccess":true,"defaultNotifier":true,"pageId":24}));</script>',
      1 => '<script>window.addEventListener(\'DOMContentLoaded\', () => FetchIt.create({"action":"5b4338599cb530c4f36ba76d3d9ca4ab","assetsUrl":"\\/assets\\/components\\/fetchit\\/","actionUrl":"\\/assets\\/components\\/fetchit\\/action.php","inputInvalidClass":"is-invalid","customInvalidClass":"","clearFieldsOnSuccess":true,"defaultNotifier":true,"pageId":24}));</script>',
      2 => '<script>window.addEventListener(\'DOMContentLoaded\', () => FetchIt.create({"action":"2029d1f69fef7a3da586f22ea1bd2322","assetsUrl":"\\/assets\\/components\\/fetchit\\/","actionUrl":"\\/assets\\/components\\/fetchit\\/action.php","inputInvalidClass":"is-invalid","customInvalidClass":"","clearFieldsOnSuccess":true,"defaultNotifier":true,"pageId":24}));</script>',
    ),
    '_loadedjscripts' => 
    array (
      '<script>window.addEventListener(\'DOMContentLoaded\', () => FetchIt.create({"action":"070cab3b8f0acaa298be32e93ae6d8fe","assetsUrl":"\\/assets\\/components\\/fetchit\\/","actionUrl":"\\/assets\\/components\\/fetchit\\/action.php","inputInvalidClass":"is-invalid","customInvalidClass":"","clearFieldsOnSuccess":true,"defaultNotifier":true,"pageId":24}));</script>' => true,
      '<script>window.addEventListener(\'DOMContentLoaded\', () => FetchIt.create({"action":"5b4338599cb530c4f36ba76d3d9ca4ab","assetsUrl":"\\/assets\\/components\\/fetchit\\/","actionUrl":"\\/assets\\/components\\/fetchit\\/action.php","inputInvalidClass":"is-invalid","customInvalidClass":"","clearFieldsOnSuccess":true,"defaultNotifier":true,"pageId":24}));</script>' => true,
      '<script>window.addEventListener(\'DOMContentLoaded\', () => FetchIt.create({"action":"2029d1f69fef7a3da586f22ea1bd2322","assetsUrl":"\\/assets\\/components\\/fetchit\\/","actionUrl":"\\/assets\\/components\\/fetchit\\/action.php","inputInvalidClass":"is-invalid","customInvalidClass":"","clearFieldsOnSuccess":true,"defaultNotifier":true,"pageId":24}));</script>' => true,
    ),
  ),
  'contentType' => 
  array (
...
{/ignore}',
    '[[phpthumbon?input=`assets/img/фото_топографическая_съемка/background.jpg`&options=`w=768&f=webp&q=75`&pdoTools=`cd17178b3a750b1dcfa79e6cc9883a4b`]]' => '/assets/cache_image/assets/img/фото_топографическая_съемка/background_768x0_eb8.webp',
    '[[phpthumbon?input=`assets/img/фото_топографическая_съемка/background.jpg`&options=`w=1920&f=webp&q=75`&pdoTools=`23cf8bfd0339456388f8ffbcb7086458`]]' => '/assets/cache_image/assets/img/фото_топографическая_съемка/background_1920x0_aa5.webp',
    '[[FetchIt?form=`@INLINE <form method="POST" class="md:col-span-3 p-6 bg-white">
                                    ...
                                    <div class="flex flex-col gap-4 text-black">
                                        <input name="Имя" type="text" placeholder="Ваше имя" required
                                            ...
                                            style="color:black">
                                        <input type="tel" name="Телефон" placeholder="(999) 999-99-99" maxlength="18" inputmode="numeric" autocomplete="tel" data-type-phone class="!text-black w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#558255] focus:border-transparent transition" required>
                                        <input type="hidden" name="Страница" value="https://domozmsk.ru/uslugi/topographic-survey/">
                                        <input type="hidden" name="Название страницы" value="Топографическая съемка">
                                        <button type="submit"
                                                class="w-full bg-[#558255] hover:bg-[#3d5c3d] text-white py-3.5 rounded-xl text-base font-bold transition shadow-md mt-2">
                                                Получить расчет
                                        </button>
    ...
    '[[phpthumbon?input=`assets/img/фото_топографическая_съемка/фотки/03.png`&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`78fc92e442648bab88e53e0f0db5784e`]]' => '/assets/cache_image/assets/img/фото_топографическая_съемка/фотки/03_800x600_af0.webp',
    '[[phpthumbon?input=`assets/img/фото_топографическая_съемка/фотки/01.jpg`&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`3685fb4bbe514643ee73fb26e967fed3`]]' => '/assets/cache_image/assets/img/фото_топографическая_съемка/фотки/01_800x600_af0.webp',
    '[[phpthumbon?input=`assets/img/фото_топографическая_съемка/фотки/04.jpg`&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`68849abeaebb77b0047bb9dc09f53423`]]' => '/assets/cache_image/assets/img/фото_топографическая_съемка/фотки/04_800x600_af0.webp',
...
`&toPlaceholder=``&parents=`0`&includeContent=``&includeTVs=`img_cat,price_cat,link_cat,categoryi`&prepareTVs=`1`&processTVs=``&tvPrefix=``&tvFilters=``&tvFiltersAndDelimiter=`,`&tvFiltersOrDelimiter=`||`&where=``&showUnpublished=``&showDeleted=``&showHidden=`1`&hideContainers=``&context=``&idx=``&first=``&last=``&tplFirst=``&tplLast=``&tplOdd=``&tplWrapper=``&wrapIfEmpty=``&totalVar=`total`&resources=`90,91,92`&tplCondition=``&tplOperator=`==`&conditionalTpls=``&select=``&toSeparatePlaceholders=``&loadModels=``&scheme=``&useWeblinkUrl=``]]' => '<div class="overflow-hidden service-card group border border-gray-200 bg-white shadow-sm rounded-2xl"
                        itemscope itemtype="https://schema.org/Service">
                        <meta itemprop="name" content="Подеревная топографическая съемка участка в Москве">
                        <meta itemprop="description"
                            content="Предложение компании ландшафтного дизайна в Москве и МО - Подеревная топографическая съемка участка в Москве под ключ в Подмосковье. Цены, сроки и стоимость работ.">
                                                <div class="relative h-52 rounded-2xl">
                            <div class="swiper swiper-type-one w-full h-full">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img decoding="async" itemprop="image" alt="Подеревная топографическая съемка участка в Москве" fetchpriority="high" src="/assets/cache_image/assets/img/фото_топографическая_съемка/фотки/03_800x600_af0.webp" class="w-full h-full object-cover" width="800" height="600">
                                    </div>
                                </div>
                            </div>
                            <div
                                class="absolute bottom-0 left-0 right-0 z-20 p-4 bg-gradient-to-t from-black/70 to-transparent">
                                                                <h3 class="mt-1 font-semibold text-white text-lg text-start" itemprop="name">
                                    Подеревная топографическая съемка участка в Москве                                </h3>
                            </div>
                        </div>
...
<div class="overflow-hidden service-card group border border-gray-200 bg-white shadow-sm rounded-2xl"
                        itemscope itemtype="https://schema.org/Service">
                        <meta itemprop="name" content="Топографическая съемка для ландшафтного дизайна">
                        <meta itemprop="description"
                            content="Предложение компании ландшафтного дизайна в Москве и МО - Топографическая съемка для ландшафтного дизайна под ключ в Подмосковье. Цены, сроки и стоимость работ.">
                                                <div class="relative h-52 rounded-2xl">
                            <div class="swiper swiper-type-one w-full h-full">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img decoding="async" itemprop="image" alt="Топографическая съемка для ландшафтного дизайна" loading="lazy" src="/assets/cache_image/assets/img/фото_топографическая_съемка/фотки/01_800x600_af0.webp" class="w-full h-full object-cover" width="800" height="600">
                                    </div>
                                </div>
                            </div>
                            <div
                                class="absolute bottom-0 left-0 right-0 z-20 p-4 bg-gradient-to-t from-black/70 to-transparent">
                                                                <h3 class="mt-1 font-semibold text-white text-lg text-start" itemprop="name">
                                    Топографическая съемка для ландшафтного дизайна                                </h3>
                            </div>
                        </div>
...
<div class="overflow-hidden service-card group border border-gray-200 bg-white shadow-sm rounded-2xl"
                        itemscope itemtype="https://schema.org/Service">
                        <meta itemprop="name" content="Топографическая съемка для строительства дома">
                        <meta itemprop="description"
                            content="Предложение компании ландшафтного дизайна в Москве и МО - Топографическая съемка для строительства дома под ключ в Подмосковье. Цены, сроки и стоимость работ.">
                                                <div class="relative h-52 rounded-2xl">
                            <div class="swiper swiper-type-one w-full h-full">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img decoding="async" itemprop="image" alt="Топографическая съемка для строительства дома" loading="lazy" src="/assets/cache_image/assets/img/фото_топографическая_съемка/фотки/04_800x600_af0.webp" class="w-full h-full object-cover" width="800" height="600">
                                    </div>
                                </div>
                            </div>
                            <div
                                class="absolute bottom-0 left-0 right-0 z-20 p-4 bg-gradient-to-t from-black/70 to-transparent">
                                                                <h3 class="mt-1 font-semibold text-white text-lg text-start" itemprop="name">
                                    Топографическая съемка для строительства дома                                </h3>
                            </div>
                        </div>

                    </div>',
    '[[phpthumbon?input=`assets/img/фото_топографическая_съемка/фотки/03.png`&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`8f37d1a4366b136bdb148d48e0cbf2da`]]' => '/assets/cache_image/assets/img/фото_топографическая_съемка/фотки/03_800x600_af0.webp',
    '[[phpthumbon?input=`assets/img/фото_топографическая_съемка/фотки/03.png`&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`26658529937ada8ced48c7326667adee`]]' => '/assets/cache_image/assets/img/фото_топографическая_съемка/фотки/03_800x600_af0.webp',
    '[[phpthumbon?input=`assets/img/фото_топографическая_съемка/фотки/01.jpg`&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`f461e3d46d91817de1933f64d04fd81b`]]' => '/assets/cache_image/assets/img/фото_топографическая_съемка/фотки/01_800x600_af0.webp',
    '[[phpthumbon?input=`assets/img/фото_топографическая_съемка/фотки/01.jpg`&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`5eb018a752eea85b8049c81268f9bf83`]]' => '/assets/cache_image/assets/img/фото_топографическая_съемка/фотки/01_800x600_af0.webp',
    '[[phpthumbon?input=`assets/img/фото_топографическая_съемка/фотки/04.jpg`&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`a910fb987272a3f9c5021aea6fe1f1dc`]]' => '/assets/cache_image/assets/img/фото_топографическая_съемка/фотки/04_800x600_af0.webp',
    '[[phpthumbon?input=`assets/img/фото_топографическая_съемка/фотки/04.jpg`&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`2d0d769959a8530a4a673d9681150ef4`]]' => '/assets/cache_image/assets/img/фото_топографическая_съемка/фотки/04_800x600_af0.webp',
...
',
    '[[FetchIt?form=`@INLINE <form id="pom-modal" class="modal-form">
            ...
            </form>`&snippet=`FormIt`&actionUrl=`[[+assetsUrl]]action.php`&clearFieldsOnSuccess=`1`&hooks=`email`&emailTo=`Domoz.77@yandex.ru`&emailSubject=`Заявка с модального окна - Топографическая съемка`&successMessage=`<div class="modal-success"><svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#558255" stroke-width="2"><path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg><h3>Спасибо!</h3><p>Мы свяжемся с вами в ближайшее время</p></div>`&validate=`af_name:required:minLength=2,af_phone:required,af_email:required:email`]]' => '<form data-fetchit="2029d1f69fef7a3da586f22ea1bd2322" method="post" id="pom-modal" class="modal-form">
            <input name="workemail" hidden>
            <input name="page" hidden value="Топографическая съемка">
            <input name="url" hidden value="https://domozmsk.ru/uslugi/topographic-survey/">
            <input type="hidden" name="form_subject" value="Заявка с модального окна - Топографическая съемка">
    ...
    '[[~24? &scheme=`full`]]' => 'https://domozmsk.ru/uslugi/topographic-survey/',
    '[[SchemaHome]]' => '<script type="application/ld+json">
{
    ...
    "@graph": [
        ...
        {
            "@type": "WebPage",
            "@id": "https://domozmsk.ru/uslugi/topographic-survey/#webpage",
        ...
        {
            "@type": "BreadcrumbList",
            "@id": "https://domozmsk.ru/uslugi/topographic-survey/#breadcrumb",
            "itemListElement": [
                {
                    "@type": "ListItem",
                    "position": 1,
        ...
        {
            "@type": "WebApplication",
            "@id": "https://domozmsk.ru/uslugi/topographic-survey/#calculator",
            "name": "Калькулятор стоимости ландшафтного дизайна",
            "url": "https://domozmsk.ru/uslugi/topographic-survey/#kviz",
        ...
        {
            "@type": "ItemList",
            "@id": "https://domozmsk.ru/uslugi/topographic-survey/#services",
            ...
            "itemListElement": [
                {
                    ...
                    "item": {
                        "@type": "Service",
                        "name": "Топографическая съемка для строительства дома",
                        "url": "https://domozmsk.ru/uslugi/topographic-survey/topograficheskaya-semka-dlya-stroitelstva-doma",
                        "provider": {
                            "@id": "https://domozmsk.ru/#organization"
                        },
                        "areaServed": [
                ...
                },
                {
                    ...
                    "item": {
                        "@type": "Service",
                        "name": "Топографическая съемка для ландшафтного дизайна",
                        "url": "https://domozmsk.ru/uslugi/topographic-survey/topograficheskaya-semka-dlya-landshaftnogo-dizajna",
                        "provider": {
                            "@id": "https://domozmsk.ru/#organization"
                        },
                        "areaServed": [
                ...
                },
                {
                    ...
                    "item": {
                        "@type": "Service",
                        "name": "Подеревная топографическая съемка участка в Москве",
                        "url": "https://domozmsk.ru/uslugi/topographic-survey/poderevnaya-topograficheskaya-semka",
                        "provider": {
                            "@id": "https://domozmsk.ru/#organization"
                        },
                        "areaServed": [
        ...
        {
            "@type": "Service",
            "@id": "https://domozmsk.ru/uslugi/topographic-survey/#service",
        ...
        },
        {
            ...
            "@id": "https://domozmsk.ru/uslugi/topographic-survey/#nav",
            "name": "Главное меню",
            "hasPart": [
                {
                    "@type": "SiteNavigationElement",
                    "name": "Услуги",
                    "url": "https://domozmsk.ru/uslugi/topographic-survey/#vidy"
                },
                {
                    "@type": "SiteNavigationElement",
                    "name": "Цены",
