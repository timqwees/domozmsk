<?php if(time() > 1789480617){return null;} return array (
...
',
    ...
    array (
      0 => 'img_cat',
      1 => 'assets/img/blog/Что делать с глинистой почвой на участке/background.jpg',
      2 => 'default',
      3 => NULL,
      4 => 'image',
    ),
    ...
    array (
      0 => 'the_link',
      1 => 'https://domozmsk.ru/blog/chto-delat-s-glinistoj-pochvoj-na-uchastke',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
...
{/ignore}
    ...
    '_jscripts' => 
    array (
      0 => '<script>window.addEventListener(\'DOMContentLoaded\', () => FetchIt.create({"action":"5b4338599cb530c4f36ba76d3d9ca4ab","assetsUrl":"\\/assets\\/components\\/fetchit\\/","actionUrl":"\\/assets\\/components\\/fetchit\\/action.php","inputInvalidClass":"is-invalid","customInvalidClass":"","clearFieldsOnSuccess":true,"defaultNotifier":true,"pageId":96}));</script>',
      1 => '<script>window.addEventListener(\'DOMContentLoaded\', () => FetchIt.create({"action":"dc301e1b21e9d33df629504fb298ff9d","assetsUrl":"\\/assets\\/components\\/fetchit\\/","actionUrl":"\\/assets\\/components\\/fetchit\\/action.php","inputInvalidClass":"is-invalid","customInvalidClass":"","clearFieldsOnSuccess":true,"defaultNotifier":true,"pageId":96}));</script>',
    ),
    '_loadedjscripts' => 
    array (
      '<script>window.addEventListener(\'DOMContentLoaded\', () => FetchIt.create({"action":"5b4338599cb530c4f36ba76d3d9ca4ab","assetsUrl":"\\/assets\\/components\\/fetchit\\/","actionUrl":"\\/assets\\/components\\/fetchit\\/action.php","inputInvalidClass":"is-invalid","customInvalidClass":"","clearFieldsOnSuccess":true,"defaultNotifier":true,"pageId":96}));</script>' => true,
      '<script>window.addEventListener(\'DOMContentLoaded\', () => FetchIt.create({"action":"dc301e1b21e9d33df629504fb298ff9d","assetsUrl":"\\/assets\\/components\\/fetchit\\/","actionUrl":"\\/assets\\/components\\/fetchit\\/action.php","inputInvalidClass":"is-invalid","customInvalidClass":"","clearFieldsOnSuccess":true,"defaultNotifier":true,"pageId":96}));</script>' => true,
    ),
  ),
  'contentType' => 
  array (
...
{/ignore}',
    '[[phpthumbon?input=`assets/img/блог_10/Xncwi.jpg`&options=`w=120&h=90&zc=1`&pdoTools=`3246fcedbafa9ffe54effda27eba9cf2`]]' => '/assets/cache_image/assets/img/блог_10/Xncwi_120x90_283.jpg',
    '[[phpthumbon?input=`assets/img/Диагностика_участка/Elochka.jpg`&options=`w=120&h=90&zc=1`&pdoTools=`4a1934baecb9835a6735cc445e99d2cb`]]' => '/assets/cache_image/assets/img/Диагностика_участка/Elochka_120x90_283.jpg',
    '[[phpthumbon?input=`assets/img/blog/Остаточные фотографии 4 блогов/07.jpg`&options=`w=120&h=90&zc=1`&pdoTools=`1a7a101e87232998ba59a5563d537481`]]' => '/assets/cache_image/assets/img/blog/Остаточные фотографии 4 блогов/07_120x90_283.jpg',
    '[[phpthumbon?input=`assets/img/blog/Остаточные фотографии 4 блогов/020.jpg`&options=`w=120&h=90&zc=1`&pdoTools=`7e4ac1429f5bdaebb7ce96765b4e8c32`]]' => '/assets/cache_image/assets/img/blog/Остаточные фотографии 4 блогов/020_120x90_283.jpg',
...
`&toPlaceholder=``&parents=`59`&includeContent=``&includeTVs=`blog_image,blog_category`&prepareTVs=`1`&processTVs=``&tvPrefix=``&tvFilters=``&tvFiltersAndDelimiter=`,`&tvFiltersOrDelimiter=`||`&where=`cffae77c07eed1460d1f226eecdfd9ec`&showUnpublished=``&showDeleted=``&showHidden=`1`&hideContainers=``&context=``&idx=``&first=``&last=``&tplFirst=``&tplLast=``&tplOdd=``&tplWrapper=``&wrapIfEmpty=``&totalVar=`total`&resources=``&tplCondition=``&tplOperator=`==`&conditionalTpls=``&select=``&toSeparatePlaceholders=``&loadModels=``&scheme=``&useWeblinkUrl=``]]' => '<a href="blog/kak-podgotovit-avtopoliv-k-zime" class="block rounded-xl hover:bg-gray-50 p-2 transition">
...
',
    '[[FetchIt?form=`@INLINE <form id="pom-modal" class="modal-form">
            ...
            </form>`&snippet=`FormIt`&actionUrl=`[[+assetsUrl]]action.php`&clearFieldsOnSuccess=`1`&hooks=`email`&emailTo=`Domoz.77@yandex.ru`&emailSubject=`Заявка с модального окна - Что делать с глинистой почвой на участке`&successMessage=`<div class="modal-success"><svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#558255" stroke-width="2"><path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg><h3>Спасибо!</h3><p>Мы свяжемся с вами в ближайшее время</p></div>`&validate=`af_name:required:minLength=2,af_phone:required,af_email:required:email`]]' => '<form data-fetchit="dc301e1b21e9d33df629504fb298ff9d" method="post" id="pom-modal" class="modal-form">
            <input name="workemail" hidden>
            <input name="page" hidden value="Что делать с глинистой почвой на участке">
            <input name="url" hidden value="https://domozmsk.ru/blog/chto-delat-s-glinistoj-pochvoj-na-uchastke">
            <input type="hidden" name="form_subject" value="Заявка с модального окна - Что делать с глинистой почвой на участке">
