<?php if(time() > 1789463914){return null;} return array (
...
',
    ...
    array (
      0 => 'img_cat',
      1 => 'assets/img/blog/Как решить проблему стоячей воды на участке/background.png',
      2 => 'default',
      3 => NULL,
      4 => 'image',
    ),
    ...
    array (
      0 => 'the_link',
      1 => 'https://domozmsk.ru/blog/kak-reshit-problemu-stoyachej-vodyi-na-uchastke',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
...
{/ignore}
    ...
    '_jscripts' => 
    array (
      0 => '<script>window.addEventListener(\'DOMContentLoaded\', () => FetchIt.create({"action":"5b4338599cb530c4f36ba76d3d9ca4ab","assetsUrl":"\\/assets\\/components\\/fetchit\\/","actionUrl":"\\/assets\\/components\\/fetchit\\/action.php","inputInvalidClass":"is-invalid","customInvalidClass":"","clearFieldsOnSuccess":true,"defaultNotifier":true,"pageId":97}));</script>',
      1 => '<script>window.addEventListener(\'DOMContentLoaded\', () => FetchIt.create({"action":"b34e73737e0a23caba18e4f11e9a9a06","assetsUrl":"\\/assets\\/components\\/fetchit\\/","actionUrl":"\\/assets\\/components\\/fetchit\\/action.php","inputInvalidClass":"is-invalid","customInvalidClass":"","clearFieldsOnSuccess":true,"defaultNotifier":true,"pageId":97}));</script>',
    ),
    '_loadedjscripts' => 
    array (
      '<script>window.addEventListener(\'DOMContentLoaded\', () => FetchIt.create({"action":"5b4338599cb530c4f36ba76d3d9ca4ab","assetsUrl":"\\/assets\\/components\\/fetchit\\/","actionUrl":"\\/assets\\/components\\/fetchit\\/action.php","inputInvalidClass":"is-invalid","customInvalidClass":"","clearFieldsOnSuccess":true,"defaultNotifier":true,"pageId":97}));</script>' => true,
      '<script>window.addEventListener(\'DOMContentLoaded\', () => FetchIt.create({"action":"b34e73737e0a23caba18e4f11e9a9a06","assetsUrl":"\\/assets\\/components\\/fetchit\\/","actionUrl":"\\/assets\\/components\\/fetchit\\/action.php","inputInvalidClass":"is-invalid","customInvalidClass":"","clearFieldsOnSuccess":true,"defaultNotifier":true,"pageId":97}));</script>' => true,
    ),
  ),
  'contentType' => 
  array (
...
{/ignore}',
    '[[phpthumbon?input=`assets/img/блог_10/Xncwi.jpg`&options=`w=120&h=90&zc=1`&pdoTools=`335c909d99bd009ef3a3296b5be41dbe`]]' => '/assets/cache_image/assets/img/блог_10/Xncwi_120x90_283.jpg',
    '[[phpthumbon?input=`assets/img/Диагностика_участка/Elochka.jpg`&options=`w=120&h=90&zc=1`&pdoTools=`1ddd13a54d0cf15f4cd425e3d9a382f2`]]' => '/assets/cache_image/assets/img/Диагностика_участка/Elochka_120x90_283.jpg',
    '[[phpthumbon?input=`assets/img/blog/Остаточные фотографии 4 блогов/07.jpg`&options=`w=120&h=90&zc=1`&pdoTools=`56fba6fa9052f01e657c7c938866cc93`]]' => '/assets/cache_image/assets/img/blog/Остаточные фотографии 4 блогов/07_120x90_283.jpg',
    '[[phpthumbon?input=`assets/img/blog/Остаточные фотографии 4 блогов/020.jpg`&options=`w=120&h=90&zc=1`&pdoTools=`5a1aa7efcff1ed19583122e5ca82d8ea`]]' => '/assets/cache_image/assets/img/blog/Остаточные фотографии 4 блогов/020_120x90_283.jpg',
...
`&toPlaceholder=``&parents=`59`&includeContent=``&includeTVs=`blog_image,blog_category`&prepareTVs=`1`&processTVs=``&tvPrefix=``&tvFilters=``&tvFiltersAndDelimiter=`,`&tvFiltersOrDelimiter=`||`&where=`712852dc22e75f5457a64933c0f54021`&showUnpublished=``&showDeleted=``&showHidden=`1`&hideContainers=``&context=``&idx=``&first=``&last=``&tplFirst=``&tplLast=``&tplOdd=``&tplWrapper=``&wrapIfEmpty=``&totalVar=`total`&resources=``&tplCondition=``&tplOperator=`==`&conditionalTpls=``&select=``&toSeparatePlaceholders=``&loadModels=``&scheme=``&useWeblinkUrl=``]]' => '<a href="blog/kak-podgotovit-avtopoliv-k-zime" class="block rounded-xl hover:bg-gray-50 p-2 transition">
...
',
    '[[FetchIt?form=`@INLINE <form id="pom-modal" class="modal-form">
            ...
            </form>`&snippet=`FormIt`&actionUrl=`[[+assetsUrl]]action.php`&clearFieldsOnSuccess=`1`&hooks=`email`&emailTo=`Domoz.77@yandex.ru`&emailSubject=`Заявка с модального окна - Как решить проблему стоячей воды на участке`&successMessage=`<div class="modal-success"><svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#558255" stroke-width="2"><path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg><h3>Спасибо!</h3><p>Мы свяжемся с вами в ближайшее время</p></div>`&validate=`af_name:required:minLength=2,af_phone:required,af_email:required:email`]]' => '<form data-fetchit="b34e73737e0a23caba18e4f11e9a9a06" method="post" id="pom-modal" class="modal-form">
            <input name="workemail" hidden>
            <input name="page" hidden value="Как решить проблему стоячей воды на участке">
            <input name="url" hidden value="https://domozmsk.ru/blog/kak-reshit-problemu-stoyachej-vodyi-na-uchastke">
            <input type="hidden" name="form_subject" value="Заявка с модального окна - Как решить проблему стоячей воды на участке">
