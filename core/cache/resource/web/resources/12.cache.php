<?php if(time() > 1789402513){return null;} return array (
  ...
  array (
    ...
    'pagetitle' => 'Городское благоустройство и озеленение',
    'longtitle' => 'Благоустройство и озеленение участка | Дом Оз',
    'description' => 'Комплексное благоустройство участка в Москве и МО: посадка деревьев, укладка газона, мощение дорожек, цветники. Цены от 5 000 ₽/сотка. Закажите бесплатный замер!',
    'alias' => 'design-improvement-and-landscaping',
    'alias_visible' => 1,
    'link_attributes' => '',
    'published' => 1,
    'pub_date' => 0,
    ...
    'parent' => 89,
    'isfolder' => 1,
    'introtext' => 'Благоустройство и озеленение — это комплексное преображение участка от проекта до финальной посадки растений. Мы выполняем благоустройство участка цена которого включает земляные работы, мощение, посадку деревьев и газона. Озеленение под ключ — с подбором ассортимента под климат МО и ваши предпочтения. Благоустройство цена за сотку зависит от объёма работ и материалов. Озеленение Москва и область — с гарантией приживаемости растений 1 год. Комплексное благоустройство — экономия до 20% при заказе всех услуг. Бесплатный проект и 3D-визуализация!',
    'content' => '<!-- ====================================================================== --><!-- SEO-КОНТЕНТ: Благоустройство и озеленение городских территорий      --><!-- ====================================================================== -->
<section class="py-24 bg-[#f8faf8] relative overflow-hidden"><!-- Декоративный фон -->
...
<div class="max-w-4xl mx-auto px-4 z-10"><!-- Заголовок секции -->
<div class="relative text-center mb-16">
<div class="relative z-10"><span class="text-sm font-bold tracking-widest text-[#558255] uppercase mb-3 block">Экспертный материал</span>

<h2 class="text-3xl md:text-4xl font-extrabold text-[#1a1a1a] section-title mx-auto">Благоустройство и озеленение городских территорий в Москве и МО</h2>
</div>
</div>
<!-- Карточка с контентом -->

<div class="relative bg-white rounded-3xl shadow-[0_8px_30px_-10px_rgba(0,0,0,0.08)] border border-gray-100 overflow-hidden">
<div class="p-8 md:p-10"><!-- Вводный блок -->
<div class="mb-10">
<p class="text-lg text-gray-700 leading-relaxed mb-4">Компания <strong class="text-[#558255]">«Дом Оз»</strong> выполняет работы по благоустройству и озеленению городских территорий в Москве и Московской области.</p>
</div>
<!-- Список услуг -->

<div class="mb-10">
<h3 class="text-xl font-bold text-[#1a1a1a] mb-6 flex items-center gap-3"><span class="w-10 h-10 flex-shrink-0 flex items-center justify-center rounded-xl bg-[#558255]/10 text-[#558255]"><svg class="w-5 h-5" fill="none" stroke="currentColor" viewbox="0 0 24 24"> <path d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"></path> </svg> </span> Мы выполняем:</h3>

<div class="grid md:grid-cols-2 gap-3">
<div class="flex items-start gap-3 p-3 rounded-xl hover:bg-[#f0f7f0] transition duration-200"><span class="w-6 h-6 flex-shrink-0 flex items-center justify-center rounded-full bg-[#558255] text-white mt-0.5"><svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewbox="0 0 24 24"> <path d="M5 13l4 4L19 7" stroke-linecap="round" stroke-linejoin="round" stroke-width="3"></path> </svg> </span> <span class="text-gray-700">Комплексное благоустройство общественных пространств</span></div>

<div class="flex items-start gap-3 p-3 rounded-xl hover:bg-[#f0f7f0] transition duration-200"><span class="w-6 h-6 flex-shrink-0 flex items-center justify-center rounded-full bg-[#558255] text-white mt-0.5"><svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewbox="0 0 24 24"> <path d="M5 13l4 4L19 7" stroke-linecap="round" stroke-linejoin="round" stroke-width="3"></path> </svg> </span> <span class="text-gray-700">Озеленение парков, скверов и дворовых территорий</span></div>

<div class="flex items-start gap-3 p-3 rounded-xl hover:bg-[#f0f7f0] transition duration-200"><span class="w-6 h-6 flex-shrink-0 flex items-center justify-center rounded-full bg-[#558255] text-white mt-0.5"><svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewbox="0 0 24 24"> <path d="M5 13l4 4L19 7" stroke-linecap="round" stroke-linejoin="round" stroke-width="3"></path> </svg> </span> <span class="text-gray-700">Посадку деревьев, кустарников и многолетних растений</span></div>

<div class="flex items-start gap-3 p-3 rounded-xl hover:bg-[#f0f7f0] transition duration-200"><span class="w-6 h-6 flex-shrink-0 flex items-center justify-center rounded-full bg-[#558255] text-white mt-0.5"><svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewbox="0 0 24 24"> <path d="M5 13l4 4L19 7" stroke-linecap="round" stroke-linejoin="round" stroke-width="3"></path> </svg> </span> <span class="text-gray-700">Устройство рулонных и посевных газонов</span></div>

<div class="flex items-start gap-3 p-3 rounded-xl hover:bg-[#f0f7f0] transition duration-200"><span class="w-6 h-6 flex-shrink-0 flex items-center justify-center rounded-full bg-[#558255] text-white mt-0.5"><svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewbox="0 0 24 24"> <path d="M5 13l4 4L19 7" stroke-linecap="round" stroke-linejoin="round" stroke-width="3"></path> </svg> </span> <span class="text-gray-700">Создание цветников и декоративных композиций</span></div>

<div class="flex items-start gap-3 p-3 rounded-xl hover:bg-[#f0f7f0] transition duration-200"><span class="w-6 h-6 flex-shrink-0 flex items-center justify-center rounded-full bg-[#558255] text-white mt-0.5"><svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewbox="0 0 24 24"> <path d="M5 13l4 4L19 7" stroke-linecap="round" stroke-linejoin="round" stroke-width="3"></path> </svg> </span> <span class="text-gray-700">Мощение дорожек и площадок</span></div>

<div class="flex items-start gap-3 p-3 rounded-xl hover:bg-[#f0f7f0] transition duration-200"><span class="w-6 h-6 flex-shrink-0 flex items-center justify-center rounded-full bg-[#558255] text-white mt-0.5"><svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewbox="0 0 24 24"> <path d="M5 13l4 4L19 7" stroke-linecap="round" stroke-linejoin="round" stroke-width="3"></path> </svg> </span> <span class="text-gray-700">Монтаж малых архитектурных форм</span></div>

<div class="flex items-start gap-3 p-3 rounded-xl hover:bg-[#f0f7f0] transition duration-200"><span class="w-6 h-6 flex-shrink-0 flex items-center justify-center rounded-full bg-[#558255] text-white mt-0.5"><svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewbox="0 0 24 24"> <path d="M5 13l4 4L19 7" stroke-linecap="round" stroke-linejoin="round" stroke-width="3"></path> </svg> </span> <span class="text-gray-700">Устройство детских и спортивных площадок</span></div>

<div class="flex items-start gap-3 p-3 rounded-xl hover:bg-[#f0f7f0] transition duration-200"><span class="w-6 h-6 flex-shrink-0 flex items-center justify-center rounded-full bg-[#558255] text-white mt-0.5"><svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewbox="0 0 24 24"> <path d="M5 13l4 4L19 7" stroke-linecap="round" stroke-linejoin="round" stroke-width="3"></path> </svg> </span> <span class="text-gray-700">Монтаж систем освещения</span></div>

<div class="flex items-start gap-3 p-3 rounded-xl hover:bg-[#f0f7f0] transition duration-200"><span class="w-6 h-6 flex-shrink-0 flex items-center justify-center rounded-full bg-[#558255] text-white mt-0.5"><svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewbox="0 0 24 24"> <path d="M5 13l4 4L19 7" stroke-linecap="round" stroke-linejoin="round" stroke-width="3"></path> </svg> </span> <span class="text-gray-700">Установку ограждений и элементов городской инфраструктуры</span></div>
</div>
</div>
<!-- Блок "Почему это важно" -->

<div class="mb-10 bg-gradient-to-br from-[#558255]/5 to-[#d4a574]/5 rounded-2xl p-6 md:p-8 border border-[#558255]/10">
<div class="flex items-start gap-4">
<div class="w-12 h-12 flex-shrink-0 flex items-center justify-center rounded-xl bg-[#558255] text-white"><svg class="w-6 h-6" fill="none" stroke="currentColor" viewbox="0 0 24 24"> <path d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"> </path> </svg></div>

<div>
<h3 class="text-lg font-bold text-[#1a1a1a] mb-3">Почему благоустройство важно?</h3>

<p class="text-gray-700 leading-relaxed">Современное благоустройство играет важную роль в формировании <strong>комфортной городской среды</strong>. Грамотно организованное пространство повышает качество жизни жителей, делает территорию более привлекательной и способствует её эффективному использованию.</p>
</div>
</div>
</div>
<!-- Блок "Наш подход" -->
...
<div class="mb-10">
<h3 class="text-xl font-bold text-[#1a1a1a] mb-4 flex items-center gap-3"><span class="w-10 h-10 flex-shrink-0 flex items-center justify-center rounded-xl bg-[#d4a574]/20 text-[#d4a574]"><svg class="w-5 h-5" fill="none" stroke="currentColor" viewbox="0 0 24 24"> <path d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"> </path> </svg> </span> Наш подход к работе</h3>

<p class="text-gray-700 leading-relaxed mb-4">Наши специалисты разрабатывают и реализуют проекты различной сложности с учётом <strong>особенностей территории</strong>, требований заказчика и действующих нормативов. Мы уделяем внимание не только внешнему виду объектов, но и их <strong>долговечности, удобству эксплуатации и безопасности</strong>.</p>
</div>
<!-- Блок "Масштаб работ" -->

<div class="mb-8 bg-white rounded-2xl p-6 md:p-8 border-2 border-[#558255]/20">
<div class="flex items-start gap-4">
<div class="w-12 h-12 flex-shrink-0 flex items-center justify-center rounded-xl bg-[#558255]/10 text-[#558255]"><svg class="w-6 h-6" fill="none" stroke="currentColor" viewbox="0 0 24 24"> <path d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"> </path> </svg></div>

<div>
<h3 class="text-lg font-bold text-[#1a1a1a] mb-3">Масштаб работ</h3>

<p class="text-gray-700 leading-relaxed">Наша компания обладает необходимым опытом и техническими ресурсами для выполнения работ на объектах <strong>любого масштаба</strong> — от локального благоустройства дворовых территорий до реализации крупных проектов общественного пространства.</p>
</div>
</div>
</div>
<!-- Финальный CTA -->

<div class="bg-gradient-to-r from-[#558255] to-[#3d5c3d] rounded-2xl p-6 md:p-8 text-center">
<p class="text-white text-lg leading-relaxed mb-6">Мы стремимся создавать территории, которые остаются <strong>комфортными, современными и востребованными</strong> на протяжении многих лет.</p>
<a class="header_callme_viewform inline-flex items-center gap-3 px-8 py-4 bg-white text-[#558255] rounded-xl font-bold hover:bg-gray-50 transition shadow-lg transform hover:-translate-y-0.5" href="javascript:void(0)"><span>Обсудить проект благоустройства</span> <svg class="w-5 h-5" fill="none" stroke="currentColor" viewbox="0 0 24 24"> <path d="M17 8l4 4m0 0l-4 4m4-4H3" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"></path> </svg> </a></div>
</div>
</div>
</div>
</section>
',
    ...
    'publishedby' => 1,
    'menutitle' => 'Благоустройство и озеленение',
    'donthit' => 0,
    'privateweb' => 0,
    'privatemgr' => 0,
    'content_dispo' => 0,
    ...
    'context_key' => 'web',
    'content_type' => 1,
    'uri' => 'uslugi/design-improvement-and-landscaping/',
    'uri_override' => 0,
    ...
    array (
      0 => 'the_link',
      1 => 'https://domozmsk.ru/uslugi/design-improvement-and-landscaping/',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
    ...
    array (
      0 => 'baner_h1',
      1 => 'Городское благоустройство и озеленение',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
    ...
    array (
      0 => 'img_cat',
      1 => 'assets/img/фотки_благоустройство и озеленение/го.jpg',
      2 => 'default',
      3 => NULL,
      4 => 'image',
    ),
    ...
    array (
      0 => 'fy_block',
      1 => '<h2>Преимущества проектирования благоустройства в DOM OZ</h2>
...
',
    ...
    array (
      0 => 'baner_img',
      1 => '[{"MIGX_id":"3","img":"assets\\/img\\/\\u0431\\u043b\\u0430\\u0433\\u043e\\u0443\\u0441\\u0442\\u0440\\u043e\\u0439\\u0441\\u0442\\u0432\\u043e.jpg","img_mob":"assets\\/img\\/\\u0431\\u043b\\u0430\\u0433\\u043e\\u0443\\u0441\\u0442\\u0440\\u043e\\u0439\\u0441\\u0442\\u0432\\u043e.jpg"}]',
      2 => 'default',
      3 => NULL,
      4 => 'migx',
    ),
    ...
    array (
      0 => 'baner_des',
      1 => 'Создаём современные общественные пространства, которые делают городскую среду комфортнее, эстетичнее и удобнее для жителей, гостей и бизнеса.',
      2 => 'default',
      3 => NULL,
      4 => 'richtext',
    ),
...
{/ignore}
    ...
    '_jscripts' => 
    array (
      0 => '<script>window.addEventListener(\'DOMContentLoaded\', () => FetchIt.create({"action":"070cab3b8f0acaa298be32e93ae6d8fe","assetsUrl":"\\/assets\\/components\\/fetchit\\/","actionUrl":"\\/assets\\/components\\/fetchit\\/action.php","inputInvalidClass":"is-invalid","customInvalidClass":"","clearFieldsOnSuccess":true,"defaultNotifier":true,"pageId":12}));</script>',
      1 => '<script>window.addEventListener(\'DOMContentLoaded\', () => FetchIt.create({"action":"5b4338599cb530c4f36ba76d3d9ca4ab","assetsUrl":"\\/assets\\/components\\/fetchit\\/","actionUrl":"\\/assets\\/components\\/fetchit\\/action.php","inputInvalidClass":"is-invalid","customInvalidClass":"","clearFieldsOnSuccess":true,"defaultNotifier":true,"pageId":12}));</script>',
      2 => '<script>window.addEventListener(\'DOMContentLoaded\', () => FetchIt.create({"action":"e353a7d834adc0bccc325905ad8062e7","assetsUrl":"\\/assets\\/components\\/fetchit\\/","actionUrl":"\\/assets\\/components\\/fetchit\\/action.php","inputInvalidClass":"is-invalid","customInvalidClass":"","clearFieldsOnSuccess":true,"defaultNotifier":true,"pageId":12}));</script>',
    ),
    '_loadedjscripts' => 
    array (
      '<script>window.addEventListener(\'DOMContentLoaded\', () => FetchIt.create({"action":"070cab3b8f0acaa298be32e93ae6d8fe","assetsUrl":"\\/assets\\/components\\/fetchit\\/","actionUrl":"\\/assets\\/components\\/fetchit\\/action.php","inputInvalidClass":"is-invalid","customInvalidClass":"","clearFieldsOnSuccess":true,"defaultNotifier":true,"pageId":12}));</script>' => true,
      '<script>window.addEventListener(\'DOMContentLoaded\', () => FetchIt.create({"action":"5b4338599cb530c4f36ba76d3d9ca4ab","assetsUrl":"\\/assets\\/components\\/fetchit\\/","actionUrl":"\\/assets\\/components\\/fetchit\\/action.php","inputInvalidClass":"is-invalid","customInvalidClass":"","clearFieldsOnSuccess":true,"defaultNotifier":true,"pageId":12}));</script>' => true,
      '<script>window.addEventListener(\'DOMContentLoaded\', () => FetchIt.create({"action":"e353a7d834adc0bccc325905ad8062e7","assetsUrl":"\\/assets\\/components\\/fetchit\\/","actionUrl":"\\/assets\\/components\\/fetchit\\/action.php","inputInvalidClass":"is-invalid","customInvalidClass":"","clearFieldsOnSuccess":true,"defaultNotifier":true,"pageId":12}));</script>' => true,
    ),
  ),
  'contentType' => 
  array (
...
{/ignore}',
    '[[phpthumbon?input=`assets/img/благоустройство.jpg`&options=`w=768&f=webp&q=75`&pdoTools=`228c6bc2eb8f37479ca0f7e866be3257`]]' => '/assets/cache_image/assets/img/благоустройство_768x0_eb8.webp',
    '[[phpthumbon?input=`assets/img/благоустройство.jpg`&options=`w=1920&f=webp&q=75`&pdoTools=`71f05e873a15df06315e99b94f697f95`]]' => '/assets/cache_image/assets/img/благоустройство_1920x0_aa5.webp',
    '[[FetchIt?form=`@INLINE <form method="POST" class="md:col-span-3 p-6 bg-white">
                                    ...
                                    <div class="flex flex-col gap-4 text-black">
                                        <input name="Имя" type="text" placeholder="Ваше имя" required
                                            ...
                                            style="color:black">
                                        <input type="tel" name="Телефон" placeholder="(999) 999-99-99" maxlength="18" inputmode="numeric" autocomplete="tel" data-type-phone class="!text-black w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#558255] focus:border-transparent transition" required>
                                        <input type="hidden" name="Страница" value="https://domozmsk.ru/uslugi/design-improvement-and-landscaping/">
                                        <input type="hidden" name="Название страницы" value="Городское благоустройство и озеленение">
                                        <button type="submit"
                                                class="w-full bg-[#558255] hover:bg-[#3d5c3d] text-white py-3.5 rounded-xl text-base font-bold transition shadow-md mt-2">
                                                Получить расчет
                                        </button>
    ...
    '[[phpthumbon?input=`assets/img/фотки_благоустройство и озеленение/фотки/010.jpg`&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`0c01f208eb970d2dc18830679b9d92fb`]]' => '/assets/cache_image/assets/img/фотки_благоустройство и озеленение/фотки/010_800x600_af0.webp',
    '[[phpthumbon?input=`assets/img/фотки_благоустройство и озеленение/фотки/014.jpg`&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`daefc31be61df5f36e023db61d0f5b0e`]]' => '/assets/cache_image/assets/img/фотки_благоустройство и озеленение/фотки/014_800x600_af0.webp',
    '[[phpthumbon?input=`assets/img/фотки_благоустройство и озеленение/фотки/07.jpg`&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`a3d6d4fc1573de641e02b2fa1cc62b3e`]]' => '/assets/cache_image/assets/img/фотки_благоустройство и озеленение/фотки/07_800x600_af0.webp',
...
`&toPlaceholder=``&parents=`0`&includeContent=``&includeTVs=`img_cat,price_cat,link_cat,categoryi`&prepareTVs=`1`&processTVs=``&tvPrefix=``&tvFilters=``&tvFiltersAndDelimiter=`,`&tvFiltersOrDelimiter=`||`&where=``&showUnpublished=``&showDeleted=``&showHidden=`1`&hideContainers=``&context=``&idx=``&first=``&last=``&tplFirst=``&tplLast=``&tplOdd=``&tplWrapper=``&wrapIfEmpty=``&totalVar=`total`&resources=`116,117,118`&tplCondition=``&tplOperator=`==`&conditionalTpls=``&select=``&toSeparatePlaceholders=``&loadModels=``&scheme=``&useWeblinkUrl=``]]' => '<div class="overflow-hidden service-card group border border-gray-200 bg-white shadow-sm rounded-2xl"
                        itemscope itemtype="https://schema.org/Service">
                        <meta itemprop="name" content="Озеленение территорий">
                        <meta itemprop="description"
                            content="Предложение компании ландшафтного дизайна в Москве и МО - Озеленение территорий под ключ в Подмосковье. Цены, сроки и стоимость работ.">
                                                <span itemprop="offers" itemscope itemtype="https://schema.org/Offer">
                            <meta itemprop="priceCurrency" content="RUB">
                            <meta itemprop="price" content="Создание зелёных зон с использованием деревьев, кустарников, газонов и декоративных растений ">
                        </span>
                                                <div class="relative h-52 rounded-2xl">
                            <div class="swiper swiper-type-one w-full h-full">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img decoding="async" itemprop="image" alt="Озеленение территорий" fetchpriority="high" src="/assets/cache_image/assets/img/фотки_благоустройство и озеленение/фотки/010_800x600_af0.webp" class="w-full h-full object-cover" width="800" height="600">
                                    </div>
                                </div>
                            </div>
                            <div
                                class="absolute bottom-0 left-0 right-0 z-20 p-4 bg-gradient-to-t from-black/70 to-transparent">
                                                                <div class="text-xs text-black/80 w-fit bg-white rounded-lg px-2 py-1">Создание зелёных зон с использованием деревьев, кустарников, газонов и декоративных растений                                 </div>
                                                                <h3 class="mt-1 font-semibold text-white text-lg text-start" itemprop="name">
                                    Озеленение территорий                                </h3>
                            </div>
                        </div>
...
<div class="overflow-hidden service-card group border border-gray-200 bg-white shadow-sm rounded-2xl"
                        itemscope itemtype="https://schema.org/Service">
                        <meta itemprop="name" content="Благоустройство общественных пространств">
                        <meta itemprop="description"
                            content="Предложение компании ландшафтного дизайна в Москве и МО - Благоустройство общественных пространств под ключ в Подмосковье. Цены, сроки и стоимость работ.">
                                                <span itemprop="offers" itemscope itemtype="https://schema.org/Offer">
                            <meta itemprop="priceCurrency" content="RUB">
                            <meta itemprop="price" content="Полный цикл работ по созданию современных общественных пространств — от подготовки территории до сдачи объекта ">
                        </span>
                                                <div class="relative h-52 rounded-2xl">
                            <div class="swiper swiper-type-one w-full h-full">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img decoding="async" itemprop="image" alt="Благоустройство общественных пространств" loading="lazy" src="/assets/cache_image/assets/img/фотки_благоустройство и озеленение/фотки/014_800x600_af0.webp" class="w-full h-full object-cover" width="800" height="600">
                                    </div>
                                </div>
                            </div>
                            <div
                                class="absolute bottom-0 left-0 right-0 z-20 p-4 bg-gradient-to-t from-black/70 to-transparent">
                                                                <div class="text-xs text-black/80 w-fit bg-white rounded-lg px-2 py-1">Полный цикл работ по созданию современных общественных пространств — от подготовки территории до сдачи объекта                                 </div>
                                                                <h3 class="mt-1 font-semibold text-white text-lg text-start" itemprop="name">
                                    Благоустройство общественных пространств                                </h3>
                            </div>
                        </div>
...
<div class="overflow-hidden service-card group border border-gray-200 bg-white shadow-sm rounded-2xl"
                        itemscope itemtype="https://schema.org/Service">
                        <meta itemprop="name" content="Проектирование объектов благоустройства">
                        <meta itemprop="description"
                            content="Предложение компании ландшафтного дизайна в Москве и МО - Проектирование объектов благоустройства под ключ в Подмосковье. Цены, сроки и стоимость работ.">
                                                <span itemprop="offers" itemscope itemtype="https://schema.org/Offer">
                            <meta itemprop="priceCurrency" content="RUB">
                            <meta itemprop="price" content="Разработка концепций и проектных решений для общественных и коммерческих территорий">
                        </span>
                                                <div class="relative h-52 rounded-2xl">
                            <div class="swiper swiper-type-one w-full h-full">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img decoding="async" itemprop="image" alt="Проектирование объектов благоустройства" loading="lazy" src="/assets/cache_image/assets/img/фотки_благоустройство и озеленение/фотки/07_800x600_af0.webp" class="w-full h-full object-cover" width="800" height="600">
                                    </div>
                                </div>
                            </div>
                            <div
                                class="absolute bottom-0 left-0 right-0 z-20 p-4 bg-gradient-to-t from-black/70 to-transparent">
                                                                <div class="text-xs text-black/80 w-fit bg-white rounded-lg px-2 py-1">Разработка концепций и проектных решений для общественных и коммерческих территорий                                </div>
                                                                <h3 class="mt-1 font-semibold text-white text-lg text-start" itemprop="name">
                                    Проектирование объектов благоустройства                                </h3>
                            </div>
                        </div>
...
',
    '[[FetchIt?form=`@INLINE <form id="pom-modal" class="modal-form">
            ...
            </form>`&snippet=`FormIt`&actionUrl=`[[+assetsUrl]]action.php`&clearFieldsOnSuccess=`1`&hooks=`email`&emailTo=`Domoz.77@yandex.ru`&emailSubject=`Заявка с модального окна - Городское благоустройство и озеленение`&successMessage=`<div class="modal-success"><svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#558255" stroke-width="2"><path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg><h3>Спасибо!</h3><p>Мы свяжемся с вами в ближайшее время</p></div>`&validate=`af_name:required:minLength=2,af_phone:required,af_email:required:email`]]' => '<form data-fetchit="e353a7d834adc0bccc325905ad8062e7" method="post" id="pom-modal" class="modal-form">
            <input name="workemail" hidden>
            <input name="page" hidden value="Городское благоустройство и озеленение">
            <input name="url" hidden value="https://domozmsk.ru/uslugi/design-improvement-and-landscaping/">
            <input type="hidden" name="form_subject" value="Заявка с модального окна - Городское благоустройство и озеленение">
    ...
    '[[~12? &scheme=`full`]]' => 'https://domozmsk.ru/uslugi/design-improvement-and-landscaping/',
    '[[SchemaHome]]' => '<script type="application/ld+json">
{
    ...
    "@graph": [
        ...
        {
            "@type": "WebPage",
            "@id": "https://domozmsk.ru/uslugi/design-improvement-and-landscaping/#webpage",
        ...
        {
            "@type": "BreadcrumbList",
            "@id": "https://domozmsk.ru/uslugi/design-improvement-and-landscaping/#breadcrumb",
            "itemListElement": [
                {
                    "@type": "ListItem",
                    "position": 1,
        ...
        {
            "@type": "WebApplication",
            "@id": "https://domozmsk.ru/uslugi/design-improvement-and-landscaping/#calculator",
            "name": "Калькулятор стоимости ландшафтного дизайна",
            "url": "https://domozmsk.ru/uslugi/design-improvement-and-landscaping/#kviz",
        ...
        {
            "@type": "ItemList",
            "@id": "https://domozmsk.ru/uslugi/design-improvement-and-landscaping/#services",
            ...
            "itemListElement": [
                {
                    ...
                    "item": {
                        "@type": "Service",
                        "name": "Проектирование объектов благоустройства",
                        "url": "https://domozmsk.ru/uslugi/design-improvement-and-landscaping/proektirovanie-obektov-blagoustrojstva",
                        "provider": {
                            "@id": "https://domozmsk.ru/#organization"
                        },
                        "areaServed": [
                ...
                },
                {
                    ...
                    "item": {
                        ...
                        "url": "https://domozmsk.ru/uslugi/design-improvement-and-landscaping/blagoustrojstvo-obshhestvennyix-prostranstv",
                        "provider": {
                            "@id": "https://domozmsk.ru/#organization"
                        },
                        "areaServed": [
                ...
                },
                {
                    ...
                    "item": {
                        "@type": "Service",
                        "name": "Озеленение территорий",
                        "url": "https://domozmsk.ru/uslugi/design-improvement-and-landscaping/ozelenenie-territorij",
                        "provider": {
                            "@id": "https://domozmsk.ru/#organization"
                        },
                        "areaServed": [
        ...
        {
            "@type": "Service",
            "@id": "https://domozmsk.ru/uslugi/design-improvement-and-landscaping/#service",
        ...
        },
        {
            ...
            "@id": "https://domozmsk.ru/uslugi/design-improvement-and-landscaping/#nav",
            "name": "Главное меню",
            "hasPart": [
                {
                    "@type": "SiteNavigationElement",
                    "name": "Услуги",
                    "url": "https://domozmsk.ru/uslugi/design-improvement-and-landscaping/#vidy"
                },
                {
                    "@type": "SiteNavigationElement",
                    "name": "Цены",
        ...
        {
            "@type": "FAQPage",
            "@id": "https://domozmsk.ru/uslugi/design-improvement-and-landscaping/#faq",
            "mainEntity": [
                {
                    "@type": "Question",
                    "name": "Какие объекты вы благоустраиваете?",
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "Мы работаем с дворовыми территориями, жилыми комплексами, парками, скверами, общественными пространствами, коммерческими объектами и муниципальными территориями."
                    }
                },
                {
                    "@type": "Question",
                    "name": "Можно ли заказать благоустройство под ключ?",
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "Да, мы выполняем полный комплекс работ — от проектирования до реализации и сдачи объекта."
                    }
                },
                {
                    "@type": "Question",
                    "name": "Разрабатываете ли вы проект благоустройства?",
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "Да, наши специалисты разрабатывают проекты благоустройства и озеленения с учётом особенностей территории, нормативных требований и пожеланий заказчика."
                    }
                },
                {
                    "@type": "Question",
                    "name": "Работаете ли вы по государственным и коммерческим контрактам?",
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "Да, мы сотрудничаем как с частными и коммерческими заказчиками, так и с государственными учреждениями и подрядными организациями."
                    }
                },
                {
                    "@type": "Question",
                    ...
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "Да, выполняем работы по благоустройству и озеленению на объектах любой сложности по всей Москве и Московской области."
                    }
                }
            ]
        }
