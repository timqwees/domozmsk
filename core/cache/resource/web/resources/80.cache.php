<?php if(time() > 1789475051){return null;} return array (
  ...
  array (
    ...
    array (
      0 => 'the_link',
      1 => 'https://domozmsk.ru/uslugi/gazon/gazonyi-iz-czvetov-i-pochvopokrovnyix-rastenij',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
    ...
    array (
      0 => 'img_cat',
      1 => 'assets/img/фото_газон/фотки/040.jpg',
      2 => 'default',
      3 => NULL,
      4 => 'image',
    ),
...
<head>
    ...
    <link rel="preload" as="image" fetchpriority="high"
        href="{$sliders[0].img | phpthumbon : \'w=1600&h=900&zc=1&f=webp&q=75\'}"
        imagesrcset="{$sliders[0].img_mob | phpthumbon : \'w=800&h=1200&zc=1&f=webp&q=75\'} 768w, {$sliders[0].img | phpthumbon : \'w=1600&h=900&zc=1&f=webp&q=75\'} 1600w"
        imagesizes="100vw">
    {/if}
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide hero-slide">
                            <picture>
                                ...
                                <img loading="lazy" decoding="async" class="w-full h-full object-cover" src="{$slid.img}"
                                    alt="{$_modx->resource.baner_h1}">
                            </picture>
        ...
        <section class="py-24 bg-white">
            <div class="max-w-7xl mx-auto px-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mx-auto mt-6">
                    ...
                    \'parents\' => \'0\',
                    \'tpl\' => \'@CODE:
                    <a href="{$id | url}" class="overflow-hidden service-card group border border-gray-200 bg-white shadow-sm rounded-2xl"
                        itemscope itemtype="https://schema.org/Service">
                        <meta itemprop="name" content="{if empty($menutitle)}{$pagetitle}{else}{$menutitle}{/if}">
                        <meta itemprop="description"
                            content="Предложение от компани ландшафтного дизайна - {if empty($menutitle)}{$pagetitle}{else}{$menutitle}{/if}. Узнайте больше о наших услугах и ценах.">
                        {if $price_cat}
                            ...
                            <div class="swiper swiper-type-one w-full h-full">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img decoding="async" itemprop="image" alt="{$pagetitle}" loading="lazy" src="{$img_cat | phpthumbon :
                            \\\'w=800&h=600&zc=1\\\'}" class=" w-full h-full object-cover" width="1280" height="720">
                                    </div>
                                </div>
                            </div>
                            <div
            ...
            <div class="relative z-10 max-w-7xl mx-auto px-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 px-6">
                    ...
                    <div
                        ...
                        <!--    8+-->
                        <!--</div>-->
                        <img alt="опыт работы" loading="lazy" decoding="async" src="assets/img/услуги_иконки/почему мы/опыт работы.png" />
                        <h3
                    ...
                    <div
                        ...
                        <img alt="Официально" loading="lazy" decoding="async" src="assets/img/услуги_иконки/почему мы/официально.png" />
                        <h3
                            class="text-lg font-bold text-[#1a1a1a] mb-3 group-hover:text-primary transition text-center">
                            Официально</h3>
                    ...
                    <div
                        ...
                        <!--    </svg>-->
                        <!--</div>-->
                        <img alt="Точно в срок" loading="lazy" decoding="async" src="assets/img/услуги_иконки/почему мы/срок.png" />
                        <h3
                            class="text-lg font-bold text-[#1a1a1a] mb-3 group-hover:text-primary transition text-center">
                            Точно в срок</h3>
                    ...
                    <div
                        ...
                        <!--    </svg>-->
                        <!--</div>-->
                        <img alt="Под ключ" loading="lazy" decoding="async" src="assets/img/услуги_иконки/почему мы/под ключ.png" />
                        <h3
                            class="text-lg font-bold text-[#1a1a1a] mb-3 group-hover:text-primary transition text-center">
                            Под ключ</h3>
                ...
                <div class="swiper portfolio-swiper pb-12">
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide" itemscope itemtype="https://schema.org/ImageObject">
                            ...
                            <a aria-label="Фотографии карточек" href="{$photo.img | phpthumbon : \'/assets/img/услуги_иконки/icon.svg\'}"
                                ...
                                <!-- Изображение -->
                                <img loading="lazy" decoding="async" src="{$photo.img | phpthumbon : \'/assets/img/услуги_иконки/icon.svg\'}"
                                    alt="Фото работ"
...
{/ignore}
    ...
    '_jscripts' => 
    array (
      0 => '<script>window.addEventListener(\'DOMContentLoaded\', () => FetchIt.create({"action":"5b4338599cb530c4f36ba76d3d9ca4ab","assetsUrl":"\\/assets\\/components\\/fetchit\\/","actionUrl":"\\/assets\\/components\\/fetchit\\/action.php","inputInvalidClass":"is-invalid","customInvalidClass":"","clearFieldsOnSuccess":true,"defaultNotifier":true,"pageId":80}));</script>',
      1 => '<script>window.addEventListener(\'DOMContentLoaded\', () => FetchIt.create({"action":"1ef745eae504f4f4d4e9c4eb74e1d0b4","assetsUrl":"\\/assets\\/components\\/fetchit\\/","actionUrl":"\\/assets\\/components\\/fetchit\\/action.php","inputInvalidClass":"is-invalid","customInvalidClass":"","clearFieldsOnSuccess":true,"defaultNotifier":true,"pageId":80}));</script>',
    ),
    '_loadedjscripts' => 
    array (
      '<script>window.addEventListener(\'DOMContentLoaded\', () => FetchIt.create({"action":"5b4338599cb530c4f36ba76d3d9ca4ab","assetsUrl":"\\/assets\\/components\\/fetchit\\/","actionUrl":"\\/assets\\/components\\/fetchit\\/action.php","inputInvalidClass":"is-invalid","customInvalidClass":"","clearFieldsOnSuccess":true,"defaultNotifier":true,"pageId":80}));</script>' => true,
      '<script>window.addEventListener(\'DOMContentLoaded\', () => FetchIt.create({"action":"1ef745eae504f4f4d4e9c4eb74e1d0b4","assetsUrl":"\\/assets\\/components\\/fetchit\\/","actionUrl":"\\/assets\\/components\\/fetchit\\/action.php","inputInvalidClass":"is-invalid","customInvalidClass":"","clearFieldsOnSuccess":true,"defaultNotifier":true,"pageId":80}));</script>' => true,
    ),
  ),
  'contentType' => 
  array (
...
{/ignore}',
    '[[phpthumbon?input=``&options=`w=800&h=600&zc=1`&pdoTools=`f9169d789d39cef289d24e9900aafc6f`]]' => '/assets/cache_image/noimage_800x600_ed0.jpg',
    '[[phpthumbon?input=``&options=`w=800&h=600&zc=1`&pdoTools=`ad22980c3a8fe27c641047929928acab`]]' => '/assets/cache_image/noimage_800x600_ed0.jpg',
    '[[phpthumbon?input=``&options=`w=800&h=600&zc=1`&pdoTools=`cabf6f4e223005418625e408237d0c6d`]]' => '/assets/cache_image/noimage_800x600_ed0.jpg',
    '[[phpthumbon?input=``&options=`w=800&h=600&zc=1`&pdoTools=`6a7653c1bffad8c9983627b6e1cfd7c8`]]' => '/assets/cache_image/noimage_800x600_ed0.jpg',
    '[[phpthumbon?input=`assets/img/Партнерская программа/Одинцово_13 - Фото (1).jpg`&options=`w=800&h=600&zc=1`&pdoTools=`0213c6b79f5bcfcde18996e6d630956c`]]' => '/assets/cache_image/assets/img/Партнерская программа/Одинцово_13 - Фото (1)_800x600_ed0.jpg',
    '[[phpthumbon?input=``&options=`w=800&h=600&zc=1`&pdoTools=`c133a44173252c016e9123e9506a74b3`]]' => '/assets/cache_image/noimage_800x600_ed0.jpg',
    '[[pdoResources?tpl=`@CODE:
                    ...
                    </a>`&returnIds=``&showLog=``&fastMode=``&sortby=`menuindex`&sortbyTV=``&sortbyTVType=``&sortdir=`DESC`&sortdirTV=`ASC`&limit=`6`&offset=`0`&depth=`10`&outputSeparator=`
`&toPlaceholder=``&parents=`0`&includeContent=``&includeTVs=`img_cat,price_cat,link_cat,categoryi`&prepareTVs=`1`&processTVs=``&tvPrefix=``&tvFilters=``&tvFiltersAndDelimiter=`,`&tvFiltersOrDelimiter=`||`&where=``&showUnpublished=``&showDeleted=``&showHidden=`1`&hideContainers=``&context=``&idx=``&first=``&last=``&tplFirst=``&tplLast=``&tplOdd=``&tplWrapper=``&wrapIfEmpty=``&totalVar=`total`&resources=``&tplCondition=``&tplOperator=`==`&conditionalTpls=``&select=``&toSeparatePlaceholders=``&loadModels=``&scheme=``&useWeblinkUrl=``]]' => '<a href="https://domozmsk.ru/thanks" class="overflow-hidden service-card group border border-gray-200 bg-white shadow-sm rounded-2xl"
                        itemscope itemtype="https://schema.org/Service">
                        <meta itemprop="name" content="Спасибо за заявку">
                        <meta itemprop="description"
                            content="Предложение от компани ландшафтного дизайна - Спасибо за заявку. Узнайте больше о наших услугах и ценах.">
                                                <div class="relative h-52 rounded-2xl">
                            <div class="swiper swiper-type-one w-full h-full">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img decoding="async" itemprop="image" alt="Спасибо за заявку" loading="lazy" src="/assets/cache_image/noimage_800x600_ed0.jpg" class=" w-full h-full object-cover" width="1280" height="720">
                                    </div>
                                </div>
                            </div>
                            <div
...
<a href="https://domozmsk.ru/blogs" class="overflow-hidden service-card group border border-gray-200 bg-white shadow-sm rounded-2xl"
                        itemscope itemtype="https://schema.org/Service">
                        <meta itemprop="name" content="Список блогов">
                        <meta itemprop="description"
                            content="Предложение от компани ландшафтного дизайна - Список блогов. Узнайте больше о наших услугах и ценах.">
                                                <div class="relative h-52 rounded-2xl">
                            <div class="swiper swiper-type-one w-full h-full">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img decoding="async" itemprop="image" alt="Список блогов" loading="lazy" src="/assets/cache_image/noimage_800x600_ed0.jpg" class=" w-full h-full object-cover" width="1280" height="720">
                                    </div>
                                </div>
                            </div>
                            <div
...
<a href="https://domozmsk.ru/history-company/" class="overflow-hidden service-card group border border-gray-200 bg-white shadow-sm rounded-2xl"
                        itemscope itemtype="https://schema.org/Service">
                        <meta itemprop="name" content="О компании">
                        <meta itemprop="description"
                            content="Предложение от компани ландшафтного дизайна - О компании. Узнайте больше о наших услугах и ценах.">
                                                <div class="relative h-52 rounded-2xl">
                            <div class="swiper swiper-type-one w-full h-full">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img decoding="async" itemprop="image" alt="История компании" loading="lazy" src="/assets/cache_image/noimage_800x600_ed0.jpg" class=" w-full h-full object-cover" width="1280" height="720">
                                    </div>
                                </div>
                            </div>
                            <div
...
<a href="https://domozmsk.ru/privacy" class="overflow-hidden service-card group border border-gray-200 bg-white shadow-sm rounded-2xl"
                        itemscope itemtype="https://schema.org/Service">
                        <meta itemprop="name" content="Политика конфиденциальности">
                        <meta itemprop="description"
                            content="Предложение от компани ландшафтного дизайна - Политика конфиденциальности. Узнайте больше о наших услугах и ценах.">
                                                <div class="relative h-52 rounded-2xl">
                            <div class="swiper swiper-type-one w-full h-full">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img decoding="async" itemprop="image" alt="Политика конфиденциальности" loading="lazy" src="/assets/cache_image/noimage_800x600_ed0.jpg" class=" w-full h-full object-cover" width="1280" height="720">
                                    </div>
                                </div>
                            </div>
                            <div
...
<a href="https://domozmsk.ru/partnerskaya-programma" class="overflow-hidden service-card group border border-gray-200 bg-white shadow-sm rounded-2xl"
                        itemscope itemtype="https://schema.org/Service">
                        <meta itemprop="name" content="Партнерская программа">
                        <meta itemprop="description"
                            content="Предложение от компани ландшафтного дизайна - Партнерская программа. Узнайте больше о наших услугах и ценах.">
                                                <span itemprop="offers" itemscope itemtype="https://schema.org/Offer">
                            <meta itemprop="priceCurrency" content="RUB">
                            ...
                            <div class="swiper swiper-type-one w-full h-full">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img decoding="async" itemprop="image" alt="Партнерская программа" loading="lazy" src="/assets/cache_image/assets/img/Партнерская программа/Одинцово_13 - Фото (1)_800x600_ed0.jpg" class=" w-full h-full object-cover" width="1280" height="720">
                                    </div>
                                </div>
                            </div>
                            <div
...
<a href="https://domozmsk.ru/uslugi/posadka-i-peresadka-rastenij/" class="overflow-hidden service-card group border border-gray-200 bg-white shadow-sm rounded-2xl"
                        itemscope itemtype="https://schema.org/Service">
                        <meta itemprop="name" content="Посадка и пересадка растений">
                        <meta itemprop="description"
                            content="Предложение от компани ландшафтного дизайна - Посадка и пересадка растений. Узнайте больше о наших услугах и ценах.">
                                                <div class="relative h-52 rounded-2xl">
                            <div class="swiper swiper-type-one w-full h-full">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img decoding="async" itemprop="image" alt="Посадка и пересадка растений" loading="lazy" src="/assets/cache_image/noimage_800x600_ed0.jpg" class=" w-full h-full object-cover" width="1280" height="720">
                                    </div>
                                </div>
                            </div>
                            <div
...
',
    '[[FetchIt?form=`@INLINE <form id="pom-modal" class="modal-form">
            ...
            </form>`&snippet=`FormIt`&actionUrl=`[[+assetsUrl]]action.php`&clearFieldsOnSuccess=`1`&hooks=`email`&emailTo=`Domoz.77@yandex.ru`&emailSubject=`Заявка с модального окна - Газоны из цветов и почвопокровных растений`&successMessage=`<div class="modal-success"><svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#558255" stroke-width="2"><path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg><h3>Спасибо!</h3><p>Мы свяжемся с вами в ближайшее время</p></div>`&validate=`af_name:required:minLength=2,af_phone:required,af_email:required:email`]]' => '<form data-fetchit="1ef745eae504f4f4d4e9c4eb74e1d0b4" method="post" id="pom-modal" class="modal-form">
            <input name="workemail" hidden>
            <input name="page" hidden value="Газоны из цветов и почвопокровных растений">
            <input name="url" hidden value="https://domozmsk.ru/uslugi/gazon/gazonyi-iz-czvetov-i-pochvopokrovnyix-rastenij">
            <input type="hidden" name="form_subject" value="Заявка с модального окна - Газоны из цветов и почвопокровных растений">
    ...
    '[[~80? &scheme=`full`]]' => 'https://domozmsk.ru/uslugi/gazon/gazonyi-iz-czvetov-i-pochvopokrovnyix-rastenij',
    '[[SchemaHome]]' => '<script type="application/ld+json">
{
    ...
    "@graph": [
        ...
        {
            "@type": "WebPage",
            "@id": "https://domozmsk.ru/uslugi/gazon/gazonyi-iz-czvetov-i-pochvopokrovnyix-rastenij#webpage",
        ...
        {
            "@type": "BreadcrumbList",
            "@id": "https://domozmsk.ru/uslugi/gazon/gazonyi-iz-czvetov-i-pochvopokrovnyix-rastenij#breadcrumb",
            "itemListElement": [
                {
                    "@type": "ListItem",
                    "position": 1,
        ...
        {
            "@type": "WebApplication",
            "@id": "https://domozmsk.ru/uslugi/gazon/gazonyi-iz-czvetov-i-pochvopokrovnyix-rastenij#calculator",
            "name": "Калькулятор стоимости ландшафтного дизайна",
            "url": "https://domozmsk.ru/uslugi/gazon/gazonyi-iz-czvetov-i-pochvopokrovnyix-rastenij#kviz",
        ...
        {
            "@type": "Service",
            "@id": "https://domozmsk.ru/uslugi/gazon/gazonyi-iz-czvetov-i-pochvopokrovnyix-rastenij#service",
        ...
        },
        {
            ...
            "@id": "https://domozmsk.ru/uslugi/gazon/gazonyi-iz-czvetov-i-pochvopokrovnyix-rastenij#nav",
            "name": "Главное меню",
            "hasPart": [
                {
                    "@type": "SiteNavigationElement",
                    "name": "Услуги",
                    "url": "https://domozmsk.ru/uslugi/gazon/gazonyi-iz-czvetov-i-pochvopokrovnyix-rastenij#vidy"
                },
                {
                    "@type": "SiteNavigationElement",
                    "name": "Цены",
