<?php if(time() > 1789384818){return null;} return array (
...
',
    ...
    array (
      0 => 'img_cat',
      1 => 'assets/img/Диагностика_участка/Elochka.jpg',
      2 => 'default',
      3 => NULL,
      4 => 'image',
    ),
    ...
    array (
      0 => 'the_link',
      1 => 'https://domozmsk.ru/blog/kak-ponyat-nuzhen-li-drenazh-na-uchastke',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
...
{/ignore}
    ...
    '_jscripts' => 
    array (
      0 => '<script>window.addEventListener(\'DOMContentLoaded\', () => FetchIt.create({"action":"5b4338599cb530c4f36ba76d3d9ca4ab","assetsUrl":"\\/assets\\/components\\/fetchit\\/","actionUrl":"\\/assets\\/components\\/fetchit\\/action.php","inputInvalidClass":"is-invalid","customInvalidClass":"","clearFieldsOnSuccess":true,"defaultNotifier":true,"pageId":127}));</script>',
      1 => '<script>window.addEventListener(\'DOMContentLoaded\', () => FetchIt.create({"action":"edb223d71f4c3c6d9b649ebc3e8d4521","assetsUrl":"\\/assets\\/components\\/fetchit\\/","actionUrl":"\\/assets\\/components\\/fetchit\\/action.php","inputInvalidClass":"is-invalid","customInvalidClass":"","clearFieldsOnSuccess":true,"defaultNotifier":true,"pageId":127}));</script>',
    ),
    '_loadedjscripts' => 
    array (
      '<script>window.addEventListener(\'DOMContentLoaded\', () => FetchIt.create({"action":"5b4338599cb530c4f36ba76d3d9ca4ab","assetsUrl":"\\/assets\\/components\\/fetchit\\/","actionUrl":"\\/assets\\/components\\/fetchit\\/action.php","inputInvalidClass":"is-invalid","customInvalidClass":"","clearFieldsOnSuccess":true,"defaultNotifier":true,"pageId":127}));</script>' => true,
      '<script>window.addEventListener(\'DOMContentLoaded\', () => FetchIt.create({"action":"edb223d71f4c3c6d9b649ebc3e8d4521","assetsUrl":"\\/assets\\/components\\/fetchit\\/","actionUrl":"\\/assets\\/components\\/fetchit\\/action.php","inputInvalidClass":"is-invalid","customInvalidClass":"","clearFieldsOnSuccess":true,"defaultNotifier":true,"pageId":127}));</script>' => true,
    ),
  ),
  'contentType' => 
  array (
...
{/ignore}',
    '[[phpthumbon?input=`assets/img/блог_10/Xncwi.jpg`&options=`w=120&h=90&zc=1`&pdoTools=`14383f7365f5d63b3c04a8c933271a84`]]' => '/assets/cache_image/assets/img/блог_10/Xncwi_120x90_283.jpg',
    '[[phpthumbon?input=`assets/img/blog/Остаточные фотографии 4 блогов/07.jpg`&options=`w=120&h=90&zc=1`&pdoTools=`bc3471a14cc16790bc6d7360fea5379a`]]' => '/assets/cache_image/assets/img/blog/Остаточные фотографии 4 блогов/07_120x90_283.jpg',
    '[[phpthumbon?input=`assets/img/blog/Остаточные фотографии 4 блогов/020.jpg`&options=`w=120&h=90&zc=1`&pdoTools=`c36d3332da8f443135e4f9894610b070`]]' => '/assets/cache_image/assets/img/blog/Остаточные фотографии 4 блогов/020_120x90_283.jpg',
    '[[phpthumbon?input=`assets/img/blog/Остаточные фотографии 4 блогов/08.jpg`&options=`w=120&h=90&zc=1`&pdoTools=`53aee1acfd95f0b054b26f1d3685af0f`]]' => '/assets/cache_image/assets/img/blog/Остаточные фотографии 4 блогов/08_120x90_283.jpg',
...
`&toPlaceholder=``&parents=`59`&includeContent=``&includeTVs=`blog_image,blog_category`&prepareTVs=`1`&processTVs=``&tvPrefix=``&tvFilters=``&tvFiltersAndDelimiter=`,`&tvFiltersOrDelimiter=`||`&where=`7ccb86bcab6129a50239d792a1efd28e`&showUnpublished=``&showDeleted=``&showHidden=`1`&hideContainers=``&context=``&idx=``&first=``&last=``&tplFirst=``&tplLast=``&tplOdd=``&tplWrapper=``&wrapIfEmpty=``&totalVar=`total`&resources=``&tplCondition=``&tplOperator=`==`&conditionalTpls=``&select=``&toSeparatePlaceholders=``&loadModels=``&scheme=``&useWeblinkUrl=``]]' => '<a href="blog/kak-podgotovit-avtopoliv-k-zime" class="block rounded-xl hover:bg-gray-50 p-2 transition">
...
<a href="blog/landshaftnyj-dizajn-malenkogo-uchastka" class="block rounded-xl hover:bg-gray-50 p-2 transition">
    <div class="flex gap-3">
        <img class="w-[84px] h-[64px] object-cover rounded-lg lazyload" 
             data-src="/assets/cache_image/assets/img/blog/Остаточные фотографии 4 блогов/08_120x90_283.jpg" 
             alt="Ландшафтный дизайн маленького участка: решения для 4-10 соток">
        <div class="flex-1">
            <div class="text-[13px] font-extrabold leading-[16px]">Ландшафтный дизайн маленького участка: решения для 4-10 соток</div>
            <div class="mt-1 text-[11px] text-gray-500">
                02.09.2026            </div>
                    </div>
    </div>
...
',
    '[[FetchIt?form=`@INLINE <form id="pom-modal" class="modal-form">
            ...
            </form>`&snippet=`FormIt`&actionUrl=`[[+assetsUrl]]action.php`&clearFieldsOnSuccess=`1`&hooks=`email`&emailTo=`Domoz.77@yandex.ru`&emailSubject=`Заявка с модального окна - Как понять, нужен ли дренаж на участке`&successMessage=`<div class="modal-success"><svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#558255" stroke-width="2"><path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg><h3>Спасибо!</h3><p>Мы свяжемся с вами в ближайшее время</p></div>`&validate=`af_name:required:minLength=2,af_phone:required,af_email:required:email`]]' => '<form data-fetchit="edb223d71f4c3c6d9b649ebc3e8d4521" method="post" id="pom-modal" class="modal-form">
            <input name="workemail" hidden>
            <input name="page" hidden value="Как понять, нужен ли дренаж на участке">
            <input name="url" hidden value="https://domozmsk.ru/blog/kak-ponyat-nuzhen-li-drenazh-na-uchastke">
            <input type="hidden" name="form_subject" value="Заявка с модального окна - Как понять, нужен ли дренаж на участке">
