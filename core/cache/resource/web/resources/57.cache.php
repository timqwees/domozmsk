<?php if(time() > 1789485263){return null;} return array (
...
',
    ...
    array (
      0 => 'the_link',
      1 => 'https://domozmsk.ru/uslugi/uxod-za-sadom/',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
    ...
    array (
      ...
      1 => 'Даже ухоженный сад со временем теряет декоративность. Газон редеет, деревья начинают болеть, появляются вредители и сорняки. Без профессионального ухода растения постепенно теряют здоровье.',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
  ...
  },
  {
    ...
    array (
      0 => 'vidy_title',
      1 => 'Комплекс услуг по уходу за садом',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
    ...
    array (
      0 => 'baner_h1',
      1 => '<span style="color: rgb(242, 176, 105)">Услуги по уходу за садом</small> <br></span>Газоны, деревья, кустарники, цветники <span style="color: rgb(242, 176, 105)">под контролем специалистов</small></span>',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
    ...
    array (
      0 => 'img_cat',
      1 => 'assets/img/gelery/uxod-za-sadom/ray_shrewsberry-rose-pruning-7470829_1920.jpg',
      2 => 'default',
      3 => NULL,
      4 => 'image',
    ),
    ...
    array (
      0 => 'fy_block',
      1 => '<h2>Все эти проблемы мы решаем профессионально — с проектом, сметой и гарантией результата.</h2>
...
',
    ...
    array (
      0 => 'baner_des',
      1 => 'С какими проблемами сталкиваются владельцы участков? Даже ухоженный сад со временем теряет декоративность. Газон редеет, деревья начинают болеть, появляются вредители и сорняки. Без профессионального ухода растения постепенно теряют здоровье.',
      2 => 'default',
      3 => NULL,
      4 => 'richtext',
    ),
...
{/ignore}
    ...
    '_jscripts' => 
    array (
      0 => '<script>window.addEventListener(\'DOMContentLoaded\', () => FetchIt.create({"action":"070cab3b8f0acaa298be32e93ae6d8fe","assetsUrl":"\\/assets\\/components\\/fetchit\\/","actionUrl":"\\/assets\\/components\\/fetchit\\/action.php","inputInvalidClass":"is-invalid","customInvalidClass":"","clearFieldsOnSuccess":true,"defaultNotifier":true,"pageId":57}));</script>',
      1 => '<script>window.addEventListener(\'DOMContentLoaded\', () => FetchIt.create({"action":"5b4338599cb530c4f36ba76d3d9ca4ab","assetsUrl":"\\/assets\\/components\\/fetchit\\/","actionUrl":"\\/assets\\/components\\/fetchit\\/action.php","inputInvalidClass":"is-invalid","customInvalidClass":"","clearFieldsOnSuccess":true,"defaultNotifier":true,"pageId":57}));</script>',
      2 => '<script>window.addEventListener(\'DOMContentLoaded\', () => FetchIt.create({"action":"cd68a8f71358609b6784cc6381efd944","assetsUrl":"\\/assets\\/components\\/fetchit\\/","actionUrl":"\\/assets\\/components\\/fetchit\\/action.php","inputInvalidClass":"is-invalid","customInvalidClass":"","clearFieldsOnSuccess":true,"defaultNotifier":true,"pageId":57}));</script>',
    ),
    '_loadedjscripts' => 
    array (
      '<script>window.addEventListener(\'DOMContentLoaded\', () => FetchIt.create({"action":"070cab3b8f0acaa298be32e93ae6d8fe","assetsUrl":"\\/assets\\/components\\/fetchit\\/","actionUrl":"\\/assets\\/components\\/fetchit\\/action.php","inputInvalidClass":"is-invalid","customInvalidClass":"","clearFieldsOnSuccess":true,"defaultNotifier":true,"pageId":57}));</script>' => true,
      '<script>window.addEventListener(\'DOMContentLoaded\', () => FetchIt.create({"action":"5b4338599cb530c4f36ba76d3d9ca4ab","assetsUrl":"\\/assets\\/components\\/fetchit\\/","actionUrl":"\\/assets\\/components\\/fetchit\\/action.php","inputInvalidClass":"is-invalid","customInvalidClass":"","clearFieldsOnSuccess":true,"defaultNotifier":true,"pageId":57}));</script>' => true,
      '<script>window.addEventListener(\'DOMContentLoaded\', () => FetchIt.create({"action":"cd68a8f71358609b6784cc6381efd944","assetsUrl":"\\/assets\\/components\\/fetchit\\/","actionUrl":"\\/assets\\/components\\/fetchit\\/action.php","inputInvalidClass":"is-invalid","customInvalidClass":"","clearFieldsOnSuccess":true,"defaultNotifier":true,"pageId":57}));</script>' => true,
    ),
  ),
  'contentType' => 
  array (
...
{/ignore}',
    '[[phpthumbon?input=`assets/img/gelery/uxod-za-sadom/schraubgut-pruning-shears-4964455_1920.jpg`&options=`w=768&f=webp&q=75`&pdoTools=`f91243e18846f5331fb31f5ec45e878a`]]' => '/assets/cache_image/assets/img/gelery/uxod-za-sadom/schraubgut-pruning-shears-4964455_1920_768x0_eb8.webp',
    '[[phpthumbon?input=`assets/img/gelery/uxod-za-sadom/schraubgut-pruning-shears-4964455_1920.jpg`&options=`w=1920&f=webp&q=75`&pdoTools=`d315e8c262e74562b8636df0a7cfedb0`]]' => '/assets/cache_image/assets/img/gelery/uxod-za-sadom/schraubgut-pruning-shears-4964455_1920_1920x0_aa5.webp',
    '[[phpthumbon?input=`assets/img/gelery/uxod-za-sadom/ray_shrewsberry-rose-pruning-7470829_1920.jpg`&options=`w=768&f=webp&q=75`&pdoTools=`d5ab784b06452b6c45e53921de912f3f`]]' => '/assets/cache_image/assets/img/gelery/uxod-za-sadom/ray_shrewsberry-rose-pruning-7470829_1920_768x0_eb8.webp',
    '[[phpthumbon?input=`assets/img/gelery/uxod-za-sadom/ray_shrewsberry-rose-pruning-7470829_1920.jpg`&options=`w=1920&f=webp&q=75`&pdoTools=`24e393281439ccc08af3ed79ec7ae7b3`]]' => '/assets/cache_image/assets/img/gelery/uxod-za-sadom/ray_shrewsberry-rose-pruning-7470829_1920_1920x0_aa5.webp',
    '[[phpthumbon?input=`assets/img/gelery/uxod-za-sadom/wfranz-chainsaw-4815949_1920.jpg`&options=`w=768&f=webp&q=75`&pdoTools=`1d5eadbab5d8f322efdd24d87ef034c3`]]' => '/assets/cache_image/assets/img/gelery/uxod-za-sadom/wfranz-chainsaw-4815949_1920_768x0_eb8.webp',
    '[[phpthumbon?input=`assets/img/gelery/uxod-za-sadom/wfranz-chainsaw-4815949_1920.jpg`&options=`w=1920&f=webp&q=75`&pdoTools=`25beb9cdcdc7c029bd49eb4a85150357`]]' => '/assets/cache_image/assets/img/gelery/uxod-za-sadom/wfranz-chainsaw-4815949_1920_1920x0_aa5.webp',
    '[[FetchIt?form=`@INLINE <form method="POST" class="md:col-span-3 p-6 bg-white">
                                    ...
                                    <div class="flex flex-col gap-4 text-black">
                                        <input name="Имя" type="text" placeholder="Ваше имя" required
                                            ...
                                            style="color:black">
                                        <input type="tel" name="Телефон" placeholder="(999) 999-99-99" maxlength="18" inputmode="numeric" autocomplete="tel" data-type-phone class="!text-black w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#558255] focus:border-transparent transition" required>
                                        <input type="hidden" name="Страница" value="https://domozmsk.ru/uslugi/uxod-za-sadom/">
                                        <input type="hidden" name="Название страницы" value="Уход за садом">
                                        <button type="submit"
                                                class="w-full bg-[#558255] hover:bg-[#3d5c3d] text-white py-3.5 rounded-xl text-base font-bold transition shadow-md mt-2">
                                                Получить расчет
                                        </button>
    ...
    '[[phpthumbon?input=`assets/img/фото_газон/фотки/016.png`&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`aa72cd80a225700b327c83d156f2fc99`]]' => '/assets/cache_image/assets/img/фото_газон/фотки/016_800x600_af0.webp',
    '[[phpthumbon?input=`assets/img/фото_уход_за_садом/фотки/026.jpg`&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`eda7d3d75bf1a86cb275d63a713fa5df`]]' => '/assets/cache_image/assets/img/фото_уход_за_садом/фотки/026_800x600_af0.webp',
    '[[phpthumbon?input=`assets/img/фото_уход_за_садом/фотки/019.jpg`&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`4d8d6f88b9d5048d056b915be63f2fa7`]]' => '/assets/cache_image/assets/img/фото_уход_за_садом/фотки/019_800x600_af0.webp',
    '[[phpthumbon?input=`assets/img/фото_уход_за_садом/фотки/07.jpg`&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`a806817d8d76686a0f129c365676d115`]]' => '/assets/cache_image/assets/img/фото_уход_за_садом/фотки/07_800x600_af0.webp',
    '[[phpthumbon?input=`assets/img/фото_уход_за_садом/фотки/06.jpg`&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`991bf7b896e8db2ba39d94eaa873c6a1`]]' => '/assets/cache_image/assets/img/фото_уход_за_садом/фотки/06_800x600_af0.webp',
...
`&toPlaceholder=``&parents=`0`&includeContent=``&includeTVs=`img_cat,price_cat,link_cat,categoryi`&prepareTVs=`1`&processTVs=``&tvPrefix=``&tvFilters=``&tvFiltersAndDelimiter=`,`&tvFiltersOrDelimiter=`||`&where=``&showUnpublished=``&showDeleted=``&showHidden=`1`&hideContainers=``&context=``&idx=``&first=``&last=``&tplFirst=``&tplLast=``&tplOdd=``&tplWrapper=``&wrapIfEmpty=``&totalVar=`total`&resources=`74,75,76,77,78,50`&tplCondition=``&tplOperator=`==`&conditionalTpls=``&select=``&toSeparatePlaceholders=``&loadModels=``&scheme=``&useWeblinkUrl=``]]' => '<div class="overflow-hidden service-card group border border-gray-200 bg-white shadow-sm rounded-2xl"
                        itemscope itemtype="https://schema.org/Service">
                        ...
                        <meta itemprop="description"
                            ...
                            <div class="swiper swiper-type-one w-full h-full">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img decoding="async" itemprop="image" alt="Уход за газоном" fetchpriority="high" src="/assets/cache_image/assets/img/фото_газон/фотки/016_800x600_af0.webp" class="w-full h-full object-cover" width="800" height="600">
                                    </div>
                                </div>
                            </div>
                            <div
...
<div class="overflow-hidden service-card group border border-gray-200 bg-white shadow-sm rounded-2xl"
                        itemscope itemtype="https://schema.org/Service">
                        <meta itemprop="name" content="Обработка сада">
                        <meta itemprop="description"
                            content="Предложение компании ландшафтного дизайна в Москве и МО - Обработка сада под ключ в Подмосковье. Цены, сроки и стоимость работ.">
                                                <div class="relative h-52 rounded-2xl">
                            <div class="swiper swiper-type-one w-full h-full">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img decoding="async" itemprop="image" alt="Обработка сада" loading="lazy" src="/assets/cache_image/assets/img/фото_уход_за_садом/фотки/026_800x600_af0.webp" class="w-full h-full object-cover" width="800" height="600">
                                    </div>
                                </div>
                            </div>
                            <div
...
<div class="overflow-hidden service-card group border border-gray-200 bg-white shadow-sm rounded-2xl"
                        itemscope itemtype="https://schema.org/Service">
                        <meta itemprop="name" content="Стрижка живых изгородей в Москве и МО">
                        <meta itemprop="description"
                            content="Предложение компании ландшафтного дизайна в Москве и МО - Стрижка живых изгородей в Москве и МО под ключ в Подмосковье. Цены, сроки и стоимость работ.">
                                                <div class="relative h-52 rounded-2xl">
                            <div class="swiper swiper-type-one w-full h-full">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img decoding="async" itemprop="image" alt="Стрижка живых изгородей в Москве и МО" loading="lazy" src="/assets/cache_image/assets/img/фото_уход_за_садом/фотки/019_800x600_af0.webp" class="w-full h-full object-cover" width="800" height="600">
                                    </div>
                                </div>
                            </div>
                            <div
                                class="absolute bottom-0 left-0 right-0 z-20 p-4 bg-gradient-to-t from-black/70 to-transparent">
                                                                <h3 class="mt-1 font-semibold text-white text-lg text-start" itemprop="name">
                                    Стрижка живых изгородей в Москве и МО                                </h3>
                            </div>
                        </div>
...
<div class="overflow-hidden service-card group border border-gray-200 bg-white shadow-sm rounded-2xl"
                        itemscope itemtype="https://schema.org/Service">
                        <meta itemprop="name" content="Очистка водоемов в Москве и МО — чистка прудов">
                        <meta itemprop="description"
                            content="Предложение компании ландшафтного дизайна в Москве и МО - Очистка водоемов в Москве и МО — чистка прудов под ключ в Подмосковье. Цены, сроки и стоимость работ.">
                                                <div class="relative h-52 rounded-2xl">
                            <div class="swiper swiper-type-one w-full h-full">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img decoding="async" itemprop="image" alt="Очистка водоемов в Москве и МО — чистка прудов" loading="lazy" src="/assets/cache_image/assets/img/фото_уход_за_садом/фотки/07_800x600_af0.webp" class="w-full h-full object-cover" width="800" height="600">
                                    </div>
                                </div>
                            </div>
                            <div
                                class="absolute bottom-0 left-0 right-0 z-20 p-4 bg-gradient-to-t from-black/70 to-transparent">
                                                                <h3 class="mt-1 font-semibold text-white text-lg text-start" itemprop="name">
                                    Очистка водоемов в Москве и МО — чистка прудов                                </h3>
                            </div>
                        </div>
...
<div class="overflow-hidden service-card group border border-gray-200 bg-white shadow-sm rounded-2xl"
                        itemscope itemtype="https://schema.org/Service">
                        <meta itemprop="name" content="Обрезка деревьев и кустарников">
                        <meta itemprop="description"
                            content="Предложение компании ландшафтного дизайна в Москве и МО - Обрезка деревьев и кустарников под ключ в Подмосковье. Цены, сроки и стоимость работ.">
                                                <div class="relative h-52 rounded-2xl">
                            <div class="swiper swiper-type-one w-full h-full">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img decoding="async" itemprop="image" alt="Обрезка деревьев и кустарников" loading="lazy" src="/assets/cache_image/assets/img/фото_уход_за_садом/фотки/06_800x600_af0.webp" class="w-full h-full object-cover" width="800" height="600">
                                    </div>
                                </div>
                            </div>
                            <div
                                class="absolute bottom-0 left-0 right-0 z-20 p-4 bg-gradient-to-t from-black/70 to-transparent">
                                                                <h3 class="mt-1 font-semibold text-white text-lg text-start" itemprop="name">
                                    Обрезка деревьев и кустарников                                </h3>
                            </div>
                        </div>

                    </div>',
    '[[phpthumbon?input=`assets/img/фото_уход_за_садом/фотки/010.png`&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`9207b19a64ea6763c7ecfe14c1df1c51`]]' => '/assets/cache_image/assets/img/фото_уход_за_садом/фотки/010_800x600_af0.webp',
    '[[phpthumbon?input=`assets/img/фото_уход_за_садом/фотки/010.png`&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`d56704c3646c8ef447d073bf497c987a`]]' => '/assets/cache_image/assets/img/фото_уход_за_садом/фотки/010_800x600_af0.webp',
    '[[phpthumbon?input=`assets/img/фото_уход_за_садом/фотки/011.png`&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`dbd626396b1198ae8d7a953fec31d668`]]' => '/assets/cache_image/assets/img/фото_уход_за_садом/фотки/011_800x600_af0.webp',
    '[[phpthumbon?input=`assets/img/фото_уход_за_садом/фотки/011.png`&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`0af069db388bc1015f4ef0927bb29a7c`]]' => '/assets/cache_image/assets/img/фото_уход_за_садом/фотки/011_800x600_af0.webp',
    '[[phpthumbon?input=`assets/img/фото_уход_за_садом/фотки/08.png`&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`fe22901f13e0f11b393641cc001e34c0`]]' => '/assets/cache_image/assets/img/фото_уход_за_садом/фотки/08_800x600_af0.webp',
    '[[phpthumbon?input=`assets/img/фото_уход_за_садом/фотки/08.png`&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`0d6c28049f920ed0b58a4648af5b2253`]]' => '/assets/cache_image/assets/img/фото_уход_за_садом/фотки/08_800x600_af0.webp',
    '[[phpthumbon?input=`assets/img/фото_уход_за_садом/фотки/09.png`&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`46fb0b79114c8494cd86ed0831dae8a6`]]' => '/assets/cache_image/assets/img/фото_уход_за_садом/фотки/09_800x600_af0.webp',
    '[[phpthumbon?input=`assets/img/фото_уход_за_садом/фотки/09.png`&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`dd6e99fd15d2e8a93ff6a918d78bdbef`]]' => '/assets/cache_image/assets/img/фото_уход_за_садом/фотки/09_800x600_af0.webp',
...
',
    '[[FetchIt?form=`@INLINE <form id="pom-modal" class="modal-form">
            ...
            </form>`&snippet=`FormIt`&actionUrl=`[[+assetsUrl]]action.php`&clearFieldsOnSuccess=`1`&hooks=`email`&emailTo=`Domoz.77@yandex.ru`&emailSubject=`Заявка с модального окна - Уход за садом`&successMessage=`<div class="modal-success"><svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#558255" stroke-width="2"><path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg><h3>Спасибо!</h3><p>Мы свяжемся с вами в ближайшее время</p></div>`&validate=`af_name:required:minLength=2,af_phone:required,af_email:required:email`]]' => '<form data-fetchit="cd68a8f71358609b6784cc6381efd944" method="post" id="pom-modal" class="modal-form">
            <input name="workemail" hidden>
            <input name="page" hidden value="Уход за садом">
            <input name="url" hidden value="https://domozmsk.ru/uslugi/uxod-za-sadom/">
            <input type="hidden" name="form_subject" value="Заявка с модального окна - Уход за садом">
    ...
    '[[~57? &scheme=`full`]]' => 'https://domozmsk.ru/uslugi/uxod-za-sadom/',
    '[[SchemaHome]]' => '<script type="application/ld+json">
{
    ...
    "@graph": [
        ...
        {
            "@type": "WebPage",
            "@id": "https://domozmsk.ru/uslugi/uxod-za-sadom/#webpage",
        ...
        {
            "@type": "BreadcrumbList",
            "@id": "https://domozmsk.ru/uslugi/uxod-za-sadom/#breadcrumb",
            "itemListElement": [
                {
                    "@type": "ListItem",
                    "position": 1,
        ...
        {
            "@type": "WebApplication",
            "@id": "https://domozmsk.ru/uslugi/uxod-za-sadom/#calculator",
            "name": "Калькулятор стоимости ландшафтного дизайна",
            "url": "https://domozmsk.ru/uslugi/uxod-za-sadom/#kviz",
        ...
        {
            "@type": "ItemList",
            "@id": "https://domozmsk.ru/uslugi/uxod-za-sadom/#services",
            ...
            "itemListElement": [
                {
                    ...
                    "item": {
                        ...
                        "url": "https://domozmsk.ru/uslugi/uxod-za-sadom/obrezka-derevev-i-kustarnikov",
                        "provider": {
                            "@id": "https://domozmsk.ru/#organization"
                        },
                        "areaServed": [
                ...
                },
                {
                    ...
                    "item": {
                        "@type": "Service",
                        "name": "Очистка водоемов в Москве и МО — чистка прудов",
                        "url": "https://domozmsk.ru/uslugi/uxod-za-sadom/ochistka-vodoyomov",
                        "provider": {
                            "@id": "https://domozmsk.ru/#organization"
                        },
                        "areaServed": [
                ...
                },
                {
                    ...
                    "item": {
                        "@type": "Service",
                        "name": "Стрижка живых изгородей в Москве и МО",
                        "url": "https://domozmsk.ru/uslugi/uxod-za-sadom/strizhka-zhivyix-izgorodej",
                        "provider": {
                            "@id": "https://domozmsk.ru/#organization"
                        },
                        "areaServed": [
                ...
                },
                {
                    ...
                    "item": {
                        "@type": "Service",
                        "name": "Обработка сада",
                        "url": "https://domozmsk.ru/uslugi/uxod-za-sadom/obrabotka-sada",
                        "provider": {
                            "@id": "https://domozmsk.ru/#organization"
                        },
                        "areaServed": [
        ...
        {
            "@type": "Service",
            "@id": "https://domozmsk.ru/uslugi/uxod-za-sadom/#service",
        ...
        },
        {
            ...
            "@id": "https://domozmsk.ru/uslugi/uxod-za-sadom/#nav",
            "name": "Главное меню",
            "hasPart": [
                {
                    "@type": "SiteNavigationElement",
                    "name": "Услуги",
                    "url": "https://domozmsk.ru/uslugi/uxod-za-sadom/#vidy"
                },
                {
                    "@type": "SiteNavigationElement",
                    "name": "Цены",
        ...
        {
            "@type": "FAQPage",
            "@id": "https://domozmsk.ru/uslugi/uxod-za-sadom/#faq",
            "mainEntity": [
                {
                    "@type": "Question",
                    "name": "Сколько стоит уход за садом?",
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "Цена зависит от площади участка и объема работ."
                    }
                },
                {
                    "@type": "Question",
                    "name": "Как часто нужно обслуживать сад?",
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "Обычно 1–2 раза в месяц."
                    }
                },
                {
                    "@type": "Question",
                    "name": "Какие препараты используются?",
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "Используются профессиональные безопасные средства."
                    }
                }
            ]
        }
