<?php if(time() > 1789463989){return null;} return array (
  ...
  array (
    ...
    array (
      0 => 'the_link',
      1 => 'https://domozmsk.ru/uslugi/proektirovanie-moshheniya',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
    ...
    array (
      0 => 'img_cat',
      1 => 'assets/img/uslugi/mosh/fer1.png',
      2 => 'default',
      3 => NULL,
      4 => 'image',
    ),
...
<h4>Инженерная точность и функциональность</h4>

<p>Мы разрабатываем проект мощения с учётом особенностей участка, нагрузок, рельефа и водоотведения. Грамотно выполненное проектирование обеспечивает долговечность покрытия и его безупречный внешний вид на долгие годы.</p>
</div>

<div class="fy_grid-block">
<h4>Комплексный подход</h4>

<p>Проект мощения создаётся в единой концепции с ландшафтным дизайном, дорожками, площадками и инженерными системами. Мы учитываем не только эстетику, но и технологию укладки, толщину оснований и сток воды.</p>
</div>

<div class="fy_grid-block">
<h4>Индивидуальные решения</h4>

<p>Каждый проект мощения тротуарной плиткой разрабатывается под конкретный объект: от частного двора до общественного пространства. Мы подбираем оптимальные материалы — тротуарную плитку, брусчатку, камень, бетонные или декоративные покрытия — в зависимости от задач и архитектурного стиля.</p>
</div>

<div class="fy_grid-block">
<h4>Прозрачная стоимость</h4>

<p>На этапе проектирования вы получаете точную смету и фиксированную цену проекта мощения без скрытых расходов. Все решения и материалы согласуются заранее.</p>
</div>
</div>
',
      2 => 'default',
    ...
    array (
      0 => 'baner_img',
      1 => '[{"MIGX_id":"1","img":"assets\\/img\\/uslugi\\/mosh\\/fer1.png","img_mob":"assets\\/img\\/uslugi\\/mosh\\/fer1.png"}]',
      2 => 'default',
      3 => NULL,
      4 => 'migx',
    ),
    ...
    array (
      0 => 'baner_des',
      1 => 'Создаём прочные и эстетичные покрытия,<br />
которые дополняют архитектуру и<br />
подчеркивают стиль ландшафта.',
      2 => 'default',
      3 => NULL,
      4 => 'richtext',
    ),
...
{/ignore}
    ...
    '_jscripts' => 
    array (
      0 => '<script>window.addEventListener(\'DOMContentLoaded\', () => FetchIt.create({"action":"070cab3b8f0acaa298be32e93ae6d8fe","assetsUrl":"\\/assets\\/components\\/fetchit\\/","actionUrl":"\\/assets\\/components\\/fetchit\\/action.php","inputInvalidClass":"is-invalid","customInvalidClass":"","clearFieldsOnSuccess":true,"defaultNotifier":true,"pageId":46}));</script>',
      1 => '<script>window.addEventListener(\'DOMContentLoaded\', () => FetchIt.create({"action":"5b4338599cb530c4f36ba76d3d9ca4ab","assetsUrl":"\\/assets\\/components\\/fetchit\\/","actionUrl":"\\/assets\\/components\\/fetchit\\/action.php","inputInvalidClass":"is-invalid","customInvalidClass":"","clearFieldsOnSuccess":true,"defaultNotifier":true,"pageId":46}));</script>',
      2 => '<script>window.addEventListener(\'DOMContentLoaded\', () => FetchIt.create({"action":"8cda9950a2daf2537cfe84f33f460f98","assetsUrl":"\\/assets\\/components\\/fetchit\\/","actionUrl":"\\/assets\\/components\\/fetchit\\/action.php","inputInvalidClass":"is-invalid","customInvalidClass":"","clearFieldsOnSuccess":true,"defaultNotifier":true,"pageId":46}));</script>',
    ),
    '_loadedjscripts' => 
    array (
      '<script>window.addEventListener(\'DOMContentLoaded\', () => FetchIt.create({"action":"070cab3b8f0acaa298be32e93ae6d8fe","assetsUrl":"\\/assets\\/components\\/fetchit\\/","actionUrl":"\\/assets\\/components\\/fetchit\\/action.php","inputInvalidClass":"is-invalid","customInvalidClass":"","clearFieldsOnSuccess":true,"defaultNotifier":true,"pageId":46}));</script>' => true,
      '<script>window.addEventListener(\'DOMContentLoaded\', () => FetchIt.create({"action":"5b4338599cb530c4f36ba76d3d9ca4ab","assetsUrl":"\\/assets\\/components\\/fetchit\\/","actionUrl":"\\/assets\\/components\\/fetchit\\/action.php","inputInvalidClass":"is-invalid","customInvalidClass":"","clearFieldsOnSuccess":true,"defaultNotifier":true,"pageId":46}));</script>' => true,
      '<script>window.addEventListener(\'DOMContentLoaded\', () => FetchIt.create({"action":"8cda9950a2daf2537cfe84f33f460f98","assetsUrl":"\\/assets\\/components\\/fetchit\\/","actionUrl":"\\/assets\\/components\\/fetchit\\/action.php","inputInvalidClass":"is-invalid","customInvalidClass":"","clearFieldsOnSuccess":true,"defaultNotifier":true,"pageId":46}));</script>' => true,
    ),
  ),
  'contentType' => 
  array (
...
{/ignore}',
    '[[phpthumbon?input=`assets/img/uslugi/mosh/fer1.png`&options=`w=768&f=webp&q=75`&pdoTools=`799092584f65a7e749d5f9b7549645da`]]' => '/assets/cache_image/assets/img/uslugi/mosh/fer1_768x0_eb8.webp',
    '[[phpthumbon?input=`assets/img/uslugi/mosh/fer1.png`&options=`w=1920&f=webp&q=75`&pdoTools=`3075b0ec51c785a5597534e267f5b3c2`]]' => '/assets/cache_image/assets/img/uslugi/mosh/fer1_1920x0_aa5.webp',
    '[[FetchIt?form=`@INLINE <form method="POST" class="md:col-span-3 p-6 bg-white">
                                    ...
                                    <div class="flex flex-col gap-4 text-black">
                                        <input name="Имя" type="text" placeholder="Ваше имя" required
                                            ...
                                            style="color:black">
                                        <input type="tel" name="Телефон" placeholder="(999) 999-99-99" maxlength="18" inputmode="numeric" autocomplete="tel" data-type-phone class="!text-black w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#558255] focus:border-transparent transition" required>
                                        <input type="hidden" name="Страница" value="https://domozmsk.ru/uslugi/proektirovanie-moshheniya">
                                        <input type="hidden" name="Название страницы" value="Проектирование мощения">
                                        <button type="submit"
                                                class="w-full bg-[#558255] hover:bg-[#3d5c3d] text-white py-3.5 rounded-xl text-base font-bold transition shadow-md mt-2">
                                                Получить расчет
                                        </button>
    ...
    '[[phpthumbon?input=``&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`074a58928460d3a7af6fbc111e3794df`]]' => '/assets/cache_image/noimage_800x600_af0.webp',
    '[[phpthumbon?input=``&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`5909a69e84adae3b665f02ada72e4d92`]]' => '/assets/cache_image/noimage_800x600_af0.webp',
    '[[phpthumbon?input=``&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`3130f635b4787c3cc763a7f6600ea921`]]' => '/assets/cache_image/noimage_800x600_af0.webp',
    '[[phpthumbon?input=``&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`e35f07d18dd3828e36124586db1d9f2c`]]' => '/assets/cache_image/noimage_800x600_af0.webp',
    '[[phpthumbon?input=`assets/img/Партнерская программа/Одинцово_13 - Фото (1).jpg`&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`57f4e0e95043f142350657a73fd020cc`]]' => '/assets/cache_image/assets/img/Партнерская программа/Одинцово_13 - Фото (1)_800x600_af0.webp',
    '[[phpthumbon?input=``&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`7c900f6904e7816ac45a8863f1cc7850`]]' => '/assets/cache_image/noimage_800x600_af0.webp',
...
',
    '[[FetchIt?form=`@INLINE <form id="pom-modal" class="modal-form">
            ...
            </form>`&snippet=`FormIt`&actionUrl=`[[+assetsUrl]]action.php`&clearFieldsOnSuccess=`1`&hooks=`email`&emailTo=`Domoz.77@yandex.ru`&emailSubject=`Заявка с модального окна - Проектирование мощения`&successMessage=`<div class="modal-success"><svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#558255" stroke-width="2"><path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg><h3>Спасибо!</h3><p>Мы свяжемся с вами в ближайшее время</p></div>`&validate=`af_name:required:minLength=2,af_phone:required,af_email:required:email`]]' => '<form data-fetchit="8cda9950a2daf2537cfe84f33f460f98" method="post" id="pom-modal" class="modal-form">
            <input name="workemail" hidden>
            <input name="page" hidden value="Проектирование мощения">
            <input name="url" hidden value="https://domozmsk.ru/uslugi/proektirovanie-moshheniya">
            <input type="hidden" name="form_subject" value="Заявка с модального окна - Проектирование мощения">
    ...
    '[[~46? &scheme=`full`]]' => 'https://domozmsk.ru/uslugi/proektirovanie-moshheniya',
    '[[SchemaHome]]' => '<script type="application/ld+json">
{
    ...
    "@graph": [
        ...
        {
            "@type": "WebPage",
            "@id": "https://domozmsk.ru/uslugi/proektirovanie-moshheniya#webpage",
        ...
        {
            "@type": "BreadcrumbList",
            "@id": "https://domozmsk.ru/uslugi/proektirovanie-moshheniya#breadcrumb",
            "itemListElement": [
                {
                    "@type": "ListItem",
                    "position": 1,
        ...
        {
            "@type": "WebApplication",
            "@id": "https://domozmsk.ru/uslugi/proektirovanie-moshheniya#calculator",
            "name": "Калькулятор стоимости ландшафтного дизайна",
            "url": "https://domozmsk.ru/uslugi/proektirovanie-moshheniya#kviz",
        ...
        {
            "@type": "Service",
            "@id": "https://domozmsk.ru/uslugi/proektirovanie-moshheniya#service",
        ...
        },
        {
            ...
            "@id": "https://domozmsk.ru/uslugi/proektirovanie-moshheniya#nav",
            "name": "Главное меню",
            "hasPart": [
                {
                    "@type": "SiteNavigationElement",
                    "name": "Услуги",
                    "url": "https://domozmsk.ru/uslugi/proektirovanie-moshheniya#vidy"
                },
                {
                    "@type": "SiteNavigationElement",
                    "name": "Цены",
