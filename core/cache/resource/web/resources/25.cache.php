<?php if(time() > 1789400874){return null;} return array (
  ...
  array (
    ...
    array (
      0 => 'the_link',
      1 => 'https://domozmsk.ru/uslugi/design-land-plots',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
    ...
    array (
      0 => 'baner_h1',
      1 => 'Проектирование земельных участков',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
    ...
    array (
      0 => 'img_cat',
      1 => 'assets/img/gelery/landscape-design-project/проектир зу 10.jpg',
      2 => 'default',
      3 => NULL,
      4 => 'image',
    ),
...
<h4>Интеграция архитектуры и ландшафта</h4>

<p>Мы выполняем проектирование загородных участков с учётом планировки дома, рельефа и природных особенностей территории. Каждый проект земельного участка с домом создаётся так, чтобы архитектура, инженерия и природа образовывали единую композицию.</p>
</div>

<div class="fy_grid-block">
<h4>Полный цикл работ</h4>

<p>От анализа территории до 3D-визуализации — мы разрабатываем проект планировки территории земельного участка, включающий зонирование, размещение построек, дорожек, водоёмов и инженерных коммуникаций.</p>
</div>

<div class="fy_grid-block">
<h4>Индивидуальный подход</h4>

<p>Наши специалисты создают дизайн-проект земельного участка под конкретные задачи: жилое строительство, отдых, озеленение или хозяйственная зона. Можно заказать проект участка с домом как отдельную услугу или в составе общего благоустройства.</p>
</div>

<div class="fy_grid-block">
<h4>Прозрачная стоимость</h4>

<p>Мы заранее рассчитываем бюджет и объясняем, сколько стоит заказать проект участка на участке. Вы получаете точную смету без скрытых расходов, а цена фиксируется на этапе утверждения проекта.</p>
</div>
</div>
',
      2 => 'default',
    ...
    array (
      0 => 'baner_img',
      1 => '[{"MIGX_id":"2","img":"assets\\/img\\/baner1.webp","img_mob":"assets\\/img\\/baner1.webp"}]',
      2 => 'default',
      3 => NULL,
      4 => 'migx',
    ),
    ...
    array (
      0 => 'baner_des',
      1 => 'Создаём продуманные пространства, где<br />
каждая зона работает на комфорт, эстетику<br />
и функциональность.',
      2 => 'default',
      3 => NULL,
      4 => 'richtext',
...
{/ignore}
    ...
    '_jscripts' => 
    array (
      0 => '<script>window.addEventListener(\'DOMContentLoaded\', () => FetchIt.create({"action":"070cab3b8f0acaa298be32e93ae6d8fe","assetsUrl":"\\/assets\\/components\\/fetchit\\/","actionUrl":"\\/assets\\/components\\/fetchit\\/action.php","inputInvalidClass":"is-invalid","customInvalidClass":"","clearFieldsOnSuccess":true,"defaultNotifier":true,"pageId":25}));</script>',
      1 => '<script>window.addEventListener(\'DOMContentLoaded\', () => FetchIt.create({"action":"5b4338599cb530c4f36ba76d3d9ca4ab","assetsUrl":"\\/assets\\/components\\/fetchit\\/","actionUrl":"\\/assets\\/components\\/fetchit\\/action.php","inputInvalidClass":"is-invalid","customInvalidClass":"","clearFieldsOnSuccess":true,"defaultNotifier":true,"pageId":25}));</script>',
      2 => '<script>window.addEventListener(\'DOMContentLoaded\', () => FetchIt.create({"action":"e28d718b3d952926be6237ef80f34e82","assetsUrl":"\\/assets\\/components\\/fetchit\\/","actionUrl":"\\/assets\\/components\\/fetchit\\/action.php","inputInvalidClass":"is-invalid","customInvalidClass":"","clearFieldsOnSuccess":true,"defaultNotifier":true,"pageId":25}));</script>',
    ),
    '_loadedjscripts' => 
    array (
      '<script>window.addEventListener(\'DOMContentLoaded\', () => FetchIt.create({"action":"070cab3b8f0acaa298be32e93ae6d8fe","assetsUrl":"\\/assets\\/components\\/fetchit\\/","actionUrl":"\\/assets\\/components\\/fetchit\\/action.php","inputInvalidClass":"is-invalid","customInvalidClass":"","clearFieldsOnSuccess":true,"defaultNotifier":true,"pageId":25}));</script>' => true,
      '<script>window.addEventListener(\'DOMContentLoaded\', () => FetchIt.create({"action":"5b4338599cb530c4f36ba76d3d9ca4ab","assetsUrl":"\\/assets\\/components\\/fetchit\\/","actionUrl":"\\/assets\\/components\\/fetchit\\/action.php","inputInvalidClass":"is-invalid","customInvalidClass":"","clearFieldsOnSuccess":true,"defaultNotifier":true,"pageId":25}));</script>' => true,
      '<script>window.addEventListener(\'DOMContentLoaded\', () => FetchIt.create({"action":"e28d718b3d952926be6237ef80f34e82","assetsUrl":"\\/assets\\/components\\/fetchit\\/","actionUrl":"\\/assets\\/components\\/fetchit\\/action.php","inputInvalidClass":"is-invalid","customInvalidClass":"","clearFieldsOnSuccess":true,"defaultNotifier":true,"pageId":25}));</script>' => true,
    ),
  ),
  'contentType' => 
  array (
...
{/ignore}',
    '[[phpthumbon?input=`assets/img/baner1.webp`&options=`w=768&f=webp&q=75`&pdoTools=`64d16389a58e9d62d2c24ddb1ae7a6e5`]]' => '/assets/cache_image/assets/img/baner1_768x0_eb8.webp',
    '[[phpthumbon?input=`assets/img/baner1.webp`&options=`w=1920&f=webp&q=75`&pdoTools=`491b34ea6389cb8c5062b11a998b2c67`]]' => '/assets/cache_image/assets/img/baner1_1920x0_aa5.webp',
    '[[FetchIt?form=`@INLINE <form method="POST" class="md:col-span-3 p-6 bg-white">
                                    ...
                                    <div class="flex flex-col gap-4 text-black">
                                        <input name="Имя" type="text" placeholder="Ваше имя" required
                                            ...
                                            style="color:black">
                                        <input type="tel" name="Телефон" placeholder="(999) 999-99-99" maxlength="18" inputmode="numeric" autocomplete="tel" data-type-phone class="!text-black w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#558255] focus:border-transparent transition" required>
                                        <input type="hidden" name="Страница" value="https://domozmsk.ru/uslugi/design-land-plots">
                                        <input type="hidden" name="Название страницы" value="Проектирование земельных участков">
                                        <button type="submit"
                                                class="w-full bg-[#558255] hover:bg-[#3d5c3d] text-white py-3.5 rounded-xl text-base font-bold transition shadow-md mt-2">
                                                Получить расчет
                                        </button>
    ...
    '[[phpthumbon?input=``&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`f8c0fa2c4072c692bbf2862c4eb38c52`]]' => '/assets/cache_image/noimage_800x600_af0.webp',
    '[[phpthumbon?input=``&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`e75e729de5d3dc0aa6e0558c2020f4e6`]]' => '/assets/cache_image/noimage_800x600_af0.webp',
    '[[phpthumbon?input=``&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`aaeaed723b5f7fa97946358175f3660f`]]' => '/assets/cache_image/noimage_800x600_af0.webp',
    '[[phpthumbon?input=``&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`88c8bf4c6850563359a38c21d71ba985`]]' => '/assets/cache_image/noimage_800x600_af0.webp',
    '[[phpthumbon?input=`assets/img/Партнерская программа/Одинцово_13 - Фото (1).jpg`&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`b0c5814bb387fdc1745769391b8d6a0f`]]' => '/assets/cache_image/assets/img/Партнерская программа/Одинцово_13 - Фото (1)_800x600_af0.webp',
    '[[phpthumbon?input=``&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`d36bccbd60c5eb4ccecb9d3debb9de9d`]]' => '/assets/cache_image/noimage_800x600_af0.webp',
...
',
    '[[FetchIt?form=`@INLINE <form id="pom-modal" class="modal-form">
            ...
            </form>`&snippet=`FormIt`&actionUrl=`[[+assetsUrl]]action.php`&clearFieldsOnSuccess=`1`&hooks=`email`&emailTo=`Domoz.77@yandex.ru`&emailSubject=`Заявка с модального окна - Проектирование земельных участков`&successMessage=`<div class="modal-success"><svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#558255" stroke-width="2"><path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg><h3>Спасибо!</h3><p>Мы свяжемся с вами в ближайшее время</p></div>`&validate=`af_name:required:minLength=2,af_phone:required,af_email:required:email`]]' => '<form data-fetchit="e28d718b3d952926be6237ef80f34e82" method="post" id="pom-modal" class="modal-form">
            <input name="workemail" hidden>
            <input name="page" hidden value="Проектирование земельных участков">
            <input name="url" hidden value="https://domozmsk.ru/uslugi/design-land-plots">
            <input type="hidden" name="form_subject" value="Заявка с модального окна - Проектирование земельных участков">
    ...
    '[[~25? &scheme=`full`]]' => 'https://domozmsk.ru/uslugi/design-land-plots',
    '[[SchemaHome]]' => '<script type="application/ld+json">
{
    ...
    "@graph": [
        ...
        {
            "@type": "WebPage",
            "@id": "https://domozmsk.ru/uslugi/design-land-plots#webpage",
        ...
        {
            "@type": "BreadcrumbList",
            "@id": "https://domozmsk.ru/uslugi/design-land-plots#breadcrumb",
            "itemListElement": [
                {
                    "@type": "ListItem",
                    "position": 1,
        ...
        {
            "@type": "WebApplication",
            "@id": "https://domozmsk.ru/uslugi/design-land-plots#calculator",
            "name": "Калькулятор стоимости ландшафтного дизайна",
            "url": "https://domozmsk.ru/uslugi/design-land-plots#kviz",
        ...
        {
            "@type": "Service",
            "@id": "https://domozmsk.ru/uslugi/design-land-plots#service",
        ...
        },
        {
            ...
            "@id": "https://domozmsk.ru/uslugi/design-land-plots#nav",
            "name": "Главное меню",
            "hasPart": [
                {
                    "@type": "SiteNavigationElement",
                    "name": "Услуги",
                    "url": "https://domozmsk.ru/uslugi/design-land-plots#vidy"
                },
                {
                    "@type": "SiteNavigationElement",
                    "name": "Цены",
