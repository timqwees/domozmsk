<?php if(time() > 1789464689){return null;} return array (
  ...
  array (
    ...
    array (
      0 => 'the_link',
      1 => 'https://domozmsk.ru/uslugi/3d-vizualizacziya-(po-zhelaniyu)',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
    ...
    array (
      0 => 'baner_h1',
      1 => '3D-визуализация ландшафтного дизайна',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
    ...
    array (
      0 => 'img_cat',
      1 => 'assets/img/фотки_проектирование_ландшафтного_дизайна/Копия к4..jpg',
      2 => 'default',
      3 => NULL,
      4 => 'image',
    ),
    ...
    array (
      0 => 'fy_block',
      1 => '<h2>Причины заказать визуализацию дизайнерского проекта</h2>

<div class="fy_grid">
<div class="fy_grid-block">
<h4>Наглядность и реализм</h4>

<p>Визуализация ландшафтного дизайна показывает будущее пространство визуально, в реальном масштабе, цвете и освещении.</p>
</div>

<div class="fy_grid-block">
<h4>Безошибочное проектирование</h4>

<p>Моделирование проекта помогает исключить неточности при строительстве.</p>
</div>

<div class="fy_grid-block">
<h4>Точный подбор материалов и планировка</h4>

<p>П3D-визуализация заранее показывает материалы, цвета и расположение зон, позволяя сразу выбрать оптимальные решения и избежать ошибок.</p>
</div>

<div class="fy_grid-block">
<h4>Экономия времени и бюджета</h4>

<p>Наглядный проект в реальном масштабе, цвете и освещении.</p>
</div>
</div>
',
      2 => 'default',
    ...
    array (
      0 => 'baner_img',
      1 => '[{"MIGX_id":"1","img":"\\/assets\\/img\\/uslugi\\/land\\/fay.jpg","img_mob":"\\/assets\\/img\\/uslugi\\/land\\/fay.jpg"}]',
      2 => 'default',
      3 => NULL,
      4 => 'migx',
    ),
    ...
    array (
      0 => 'baner_des',
      1 => 'Создаем пространство, где каждый метр<br />
участка продуман, визуализирован и воплощен<br />
без ошибок.',
      2 => 'default',
      3 => NULL,
      4 => 'richtext',
...
{/ignore}
    ...
    '_jscripts' => 
    array (
      0 => '<script>window.addEventListener(\'DOMContentLoaded\', () => FetchIt.create({"action":"070cab3b8f0acaa298be32e93ae6d8fe","assetsUrl":"\\/assets\\/components\\/fetchit\\/","actionUrl":"\\/assets\\/components\\/fetchit\\/action.php","inputInvalidClass":"is-invalid","customInvalidClass":"","clearFieldsOnSuccess":true,"defaultNotifier":true,"pageId":40}));</script>',
      1 => '<script>window.addEventListener(\'DOMContentLoaded\', () => FetchIt.create({"action":"5b4338599cb530c4f36ba76d3d9ca4ab","assetsUrl":"\\/assets\\/components\\/fetchit\\/","actionUrl":"\\/assets\\/components\\/fetchit\\/action.php","inputInvalidClass":"is-invalid","customInvalidClass":"","clearFieldsOnSuccess":true,"defaultNotifier":true,"pageId":40}));</script>',
      2 => '<script>window.addEventListener(\'DOMContentLoaded\', () => FetchIt.create({"action":"73b0d60738cc3f64b956a0800ddbe66a","assetsUrl":"\\/assets\\/components\\/fetchit\\/","actionUrl":"\\/assets\\/components\\/fetchit\\/action.php","inputInvalidClass":"is-invalid","customInvalidClass":"","clearFieldsOnSuccess":true,"defaultNotifier":true,"pageId":40}));</script>',
    ),
    '_loadedjscripts' => 
    array (
      '<script>window.addEventListener(\'DOMContentLoaded\', () => FetchIt.create({"action":"070cab3b8f0acaa298be32e93ae6d8fe","assetsUrl":"\\/assets\\/components\\/fetchit\\/","actionUrl":"\\/assets\\/components\\/fetchit\\/action.php","inputInvalidClass":"is-invalid","customInvalidClass":"","clearFieldsOnSuccess":true,"defaultNotifier":true,"pageId":40}));</script>' => true,
      '<script>window.addEventListener(\'DOMContentLoaded\', () => FetchIt.create({"action":"5b4338599cb530c4f36ba76d3d9ca4ab","assetsUrl":"\\/assets\\/components\\/fetchit\\/","actionUrl":"\\/assets\\/components\\/fetchit\\/action.php","inputInvalidClass":"is-invalid","customInvalidClass":"","clearFieldsOnSuccess":true,"defaultNotifier":true,"pageId":40}));</script>' => true,
      '<script>window.addEventListener(\'DOMContentLoaded\', () => FetchIt.create({"action":"73b0d60738cc3f64b956a0800ddbe66a","assetsUrl":"\\/assets\\/components\\/fetchit\\/","actionUrl":"\\/assets\\/components\\/fetchit\\/action.php","inputInvalidClass":"is-invalid","customInvalidClass":"","clearFieldsOnSuccess":true,"defaultNotifier":true,"pageId":40}));</script>' => true,
    ),
  ),
  'contentType' => 
  array (
...
{/ignore}',
    '[[phpthumbon?input=`/assets/img/uslugi/land/fay.jpg`&options=`w=768&f=webp&q=75`&pdoTools=`19e7c9e9f7a590a3131c51e8e2ae690b`]]' => '/assets/cache_image/assets/img/uslugi/land/fay_768x0_eb8.webp',
    '[[phpthumbon?input=`/assets/img/uslugi/land/fay.jpg`&options=`w=1920&f=webp&q=75`&pdoTools=`afd6193e94c718f48175f324362b1a68`]]' => '/assets/cache_image/assets/img/uslugi/land/fay_1920x0_aa5.webp',
    '[[FetchIt?form=`@INLINE <form method="POST" class="md:col-span-3 p-6 bg-white">
                                    ...
                                    <div class="flex flex-col gap-4 text-black">
                                        <input name="Имя" type="text" placeholder="Ваше имя" required
                                            ...
                                            style="color:black">
                                        <input type="tel" name="Телефон" placeholder="(999) 999-99-99" maxlength="18" inputmode="numeric" autocomplete="tel" data-type-phone class="!text-black w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#558255] focus:border-transparent transition" required>
                                        <input type="hidden" name="Страница" value="https://domozmsk.ru/uslugi/3d-vizualizacziya-(po-zhelaniyu)">
                                        <input type="hidden" name="Название страницы" value="3D-визуализация">
                                        <button type="submit"
                                                class="w-full bg-[#558255] hover:bg-[#3d5c3d] text-white py-3.5 rounded-xl text-base font-bold transition shadow-md mt-2">
                                                Получить расчет
                                        </button>
    ...
    '[[phpthumbon?input=``&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`f661ac61252996f15d8b9027545f5ea6`]]' => '/assets/cache_image/noimage_800x600_af0.webp',
    '[[phpthumbon?input=``&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`16cb0c2cd0dca0ca8e265e143dbe0a1f`]]' => '/assets/cache_image/noimage_800x600_af0.webp',
    '[[phpthumbon?input=``&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`c8dfb9f7219144a8d740ad7dea8b7849`]]' => '/assets/cache_image/noimage_800x600_af0.webp',
    '[[phpthumbon?input=``&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`1888f8b5ef14163b851dc24762f0cecd`]]' => '/assets/cache_image/noimage_800x600_af0.webp',
    '[[phpthumbon?input=`assets/img/Партнерская программа/Одинцово_13 - Фото (1).jpg`&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`b5726c1a9049f1e8d941789f561b7e4e`]]' => '/assets/cache_image/assets/img/Партнерская программа/Одинцово_13 - Фото (1)_800x600_af0.webp',
    '[[phpthumbon?input=``&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`e6cf4b9e4fee38c47b7cdbe66b63e208`]]' => '/assets/cache_image/noimage_800x600_af0.webp',
...
',
    '[[FetchIt?form=`@INLINE <form id="pom-modal" class="modal-form">
            ...
            </form>`&snippet=`FormIt`&actionUrl=`[[+assetsUrl]]action.php`&clearFieldsOnSuccess=`1`&hooks=`email`&emailTo=`Domoz.77@yandex.ru`&emailSubject=`Заявка с модального окна - 3D-визуализация`&successMessage=`<div class="modal-success"><svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#558255" stroke-width="2"><path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg><h3>Спасибо!</h3><p>Мы свяжемся с вами в ближайшее время</p></div>`&validate=`af_name:required:minLength=2,af_phone:required,af_email:required:email`]]' => '<form data-fetchit="73b0d60738cc3f64b956a0800ddbe66a" method="post" id="pom-modal" class="modal-form">
            <input name="workemail" hidden>
            <input name="page" hidden value="3D-визуализация">
            <input name="url" hidden value="https://domozmsk.ru/uslugi/3d-vizualizacziya-(po-zhelaniyu)">
            <input type="hidden" name="form_subject" value="Заявка с модального окна - 3D-визуализация">
    ...
    '[[~40? &scheme=`full`]]' => 'https://domozmsk.ru/uslugi/3d-vizualizacziya-(po-zhelaniyu)',
    '[[SchemaHome]]' => '<script type="application/ld+json">
{
    ...
    "@graph": [
        ...
        {
            "@type": "WebPage",
            "@id": "https://domozmsk.ru/uslugi/3d-vizualizacziya-(po-zhelaniyu)#webpage",
        ...
        {
            "@type": "BreadcrumbList",
            "@id": "https://domozmsk.ru/uslugi/3d-vizualizacziya-(po-zhelaniyu)#breadcrumb",
            "itemListElement": [
                {
                    "@type": "ListItem",
                    "position": 1,
        ...
        {
            "@type": "WebApplication",
            "@id": "https://domozmsk.ru/uslugi/3d-vizualizacziya-(po-zhelaniyu)#calculator",
            "name": "Калькулятор стоимости ландшафтного дизайна",
            "url": "https://domozmsk.ru/uslugi/3d-vizualizacziya-(po-zhelaniyu)#kviz",
        ...
        {
            "@type": "Service",
            "@id": "https://domozmsk.ru/uslugi/3d-vizualizacziya-(po-zhelaniyu)#service",
        ...
        },
        {
            ...
            "@id": "https://domozmsk.ru/uslugi/3d-vizualizacziya-(po-zhelaniyu)#nav",
            "name": "Главное меню",
            "hasPart": [
                {
                    "@type": "SiteNavigationElement",
                    "name": "Услуги",
                    "url": "https://domozmsk.ru/uslugi/3d-vizualizacziya-(po-zhelaniyu)#vidy"
                },
                {
                    "@type": "SiteNavigationElement",
                    "name": "Цены",
