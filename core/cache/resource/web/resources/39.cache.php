<?php if(time() > 1789398179){return null;} return array (
  ...
  array (
    ...
    array (
      0 => 'the_link',
      1 => 'https://domozmsk.ru/uslugi/sxema-drenazha-i-livnevoj-kanalizaczii',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
    ...
    array (
      0 => 'baner_h1',
      1 => 'Проектирование дренажных и ливневых систем',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
    ...
    array (
      0 => 'img_cat',
      1 => 'assets/img/gelery/landscape-design-project/сх дренажа 11.jpg',
      2 => 'default',
      3 => NULL,
      4 => 'image',
    ),
...
<h4>Инженерная точность и опыт</h4>

<p>Мы более 10 лет выполняем проектирование дренажных систем участков и ливневых очистных сооружений — от частных территорий до масштабных объектов благоустройства.</p>
</div>

<div class="fy_grid-block">
<h4>Комплексный подход</h4>

<p>Проектируем дренаж и ливневку одновременно с ландшафтным дизайном, чтобы исключить конфликт инженерии и архитектуры.</p>
</div>

<div class="fy_grid-block">
<h4>Индивидуальные решения</h4>

<p>Каждый проект ливневой канализации рассчитывается по конкретным параметрам: рельеф, количество осадков, площадь водосбора, вид покрытия.</p>
</div>

<div class="fy_grid-block">
<h4>Прозрачная стоимость</h4>

<p>Мы предоставляем точный расчёт и фиксированную цену проекта дренажа участка, без скрытых платежей и дополнительных сборов.</p>
</div>
</div>
',
      2 => 'default',
    ...
    array (
      0 => 'baner_img',
      1 => '[{"MIGX_id":"1","img":"assets\\/img\\/uslugi\\/land\\/proectdren-min.webp","img_mob":"assets\\/img\\/uslugi\\/land\\/proectdren-min.webp"}]',
      2 => 'default',
      3 => NULL,
      4 => 'migx',
    ),
    ...
    array (
      0 => 'baner_des',
      1 => 'Создаём инженерные решения, которые<br />
защищают участок от влаги и сохраняют<br />
эстетику ландшафта',
      2 => 'default',
      3 => NULL,
      4 => 'richtext',
...
{/ignore}
    ...
    '_jscripts' => 
    array (
      0 => '<script>window.addEventListener(\'DOMContentLoaded\', () => FetchIt.create({"action":"070cab3b8f0acaa298be32e93ae6d8fe","assetsUrl":"\\/assets\\/components\\/fetchit\\/","actionUrl":"\\/assets\\/components\\/fetchit\\/action.php","inputInvalidClass":"is-invalid","customInvalidClass":"","clearFieldsOnSuccess":true,"defaultNotifier":true,"pageId":39}));</script>',
      1 => '<script>window.addEventListener(\'DOMContentLoaded\', () => FetchIt.create({"action":"5b4338599cb530c4f36ba76d3d9ca4ab","assetsUrl":"\\/assets\\/components\\/fetchit\\/","actionUrl":"\\/assets\\/components\\/fetchit\\/action.php","inputInvalidClass":"is-invalid","customInvalidClass":"","clearFieldsOnSuccess":true,"defaultNotifier":true,"pageId":39}));</script>',
      2 => '<script>window.addEventListener(\'DOMContentLoaded\', () => FetchIt.create({"action":"7e62ed7a05937d10fd42d608481a7fc5","assetsUrl":"\\/assets\\/components\\/fetchit\\/","actionUrl":"\\/assets\\/components\\/fetchit\\/action.php","inputInvalidClass":"is-invalid","customInvalidClass":"","clearFieldsOnSuccess":true,"defaultNotifier":true,"pageId":39}));</script>',
    ),
    '_loadedjscripts' => 
    array (
      '<script>window.addEventListener(\'DOMContentLoaded\', () => FetchIt.create({"action":"070cab3b8f0acaa298be32e93ae6d8fe","assetsUrl":"\\/assets\\/components\\/fetchit\\/","actionUrl":"\\/assets\\/components\\/fetchit\\/action.php","inputInvalidClass":"is-invalid","customInvalidClass":"","clearFieldsOnSuccess":true,"defaultNotifier":true,"pageId":39}));</script>' => true,
      '<script>window.addEventListener(\'DOMContentLoaded\', () => FetchIt.create({"action":"5b4338599cb530c4f36ba76d3d9ca4ab","assetsUrl":"\\/assets\\/components\\/fetchit\\/","actionUrl":"\\/assets\\/components\\/fetchit\\/action.php","inputInvalidClass":"is-invalid","customInvalidClass":"","clearFieldsOnSuccess":true,"defaultNotifier":true,"pageId":39}));</script>' => true,
      '<script>window.addEventListener(\'DOMContentLoaded\', () => FetchIt.create({"action":"7e62ed7a05937d10fd42d608481a7fc5","assetsUrl":"\\/assets\\/components\\/fetchit\\/","actionUrl":"\\/assets\\/components\\/fetchit\\/action.php","inputInvalidClass":"is-invalid","customInvalidClass":"","clearFieldsOnSuccess":true,"defaultNotifier":true,"pageId":39}));</script>' => true,
    ),
  ),
  'contentType' => 
  array (
...
{/ignore}',
    '[[phpthumbon?input=`assets/img/uslugi/land/proectdren-min.webp`&options=`w=768&f=webp&q=75`&pdoTools=`29472e67b3bfaeadff2845a33ad789a1`]]' => '/assets/cache_image/assets/img/uslugi/land/proectdren-min_768x0_eb8.webp',
    '[[phpthumbon?input=`assets/img/uslugi/land/proectdren-min.webp`&options=`w=1920&f=webp&q=75`&pdoTools=`7c44b73f650f7786cfee085d8a6c5053`]]' => '/assets/cache_image/assets/img/uslugi/land/proectdren-min_1920x0_aa5.webp',
    '[[FetchIt?form=`@INLINE <form method="POST" class="md:col-span-3 p-6 bg-white">
                                    ...
                                    <div class="flex flex-col gap-4 text-black">
                                        <input name="Имя" type="text" placeholder="Ваше имя" required
                                            ...
                                            style="color:black">
                                        <input type="tel" name="Телефон" placeholder="(999) 999-99-99" maxlength="18" inputmode="numeric" autocomplete="tel" data-type-phone class="!text-black w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#558255] focus:border-transparent transition" required>
                                        <input type="hidden" name="Страница" value="https://domozmsk.ru/uslugi/sxema-drenazha-i-livnevoj-kanalizaczii">
                                        <input type="hidden" name="Название страницы" value="Схема дренажа и ливневки">
                                        <button type="submit"
                                                class="w-full bg-[#558255] hover:bg-[#3d5c3d] text-white py-3.5 rounded-xl text-base font-bold transition shadow-md mt-2">
                                                Получить расчет
                                        </button>
    ...
    '[[phpthumbon?input=``&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`372e5e1f7fabb09138497676a055fb8e`]]' => '/assets/cache_image/noimage_800x600_af0.webp',
    '[[phpthumbon?input=``&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`4957fdccb0a393d4bcffdd23c47ac73e`]]' => '/assets/cache_image/noimage_800x600_af0.webp',
    '[[phpthumbon?input=``&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`af33f7fe1fcfe8b68141a5fba09ac062`]]' => '/assets/cache_image/noimage_800x600_af0.webp',
    '[[phpthumbon?input=``&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`33ca6d6c1589c1c41d613f2f6e0e1a43`]]' => '/assets/cache_image/noimage_800x600_af0.webp',
    '[[phpthumbon?input=`assets/img/Партнерская программа/Одинцово_13 - Фото (1).jpg`&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`e5df16fa739c8eec2ed6f4e02ed23994`]]' => '/assets/cache_image/assets/img/Партнерская программа/Одинцово_13 - Фото (1)_800x600_af0.webp',
    '[[phpthumbon?input=``&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`55e1eadbec5d366e6f4249343319e03e`]]' => '/assets/cache_image/noimage_800x600_af0.webp',
...
',
    '[[FetchIt?form=`@INLINE <form id="pom-modal" class="modal-form">
            ...
            </form>`&snippet=`FormIt`&actionUrl=`[[+assetsUrl]]action.php`&clearFieldsOnSuccess=`1`&hooks=`email`&emailTo=`Domoz.77@yandex.ru`&emailSubject=`Заявка с модального окна - Схема дренажа и ливневки`&successMessage=`<div class="modal-success"><svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#558255" stroke-width="2"><path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg><h3>Спасибо!</h3><p>Мы свяжемся с вами в ближайшее время</p></div>`&validate=`af_name:required:minLength=2,af_phone:required,af_email:required:email`]]' => '<form data-fetchit="7e62ed7a05937d10fd42d608481a7fc5" method="post" id="pom-modal" class="modal-form">
            <input name="workemail" hidden>
            <input name="page" hidden value="Схема дренажа и ливневки">
            <input name="url" hidden value="https://domozmsk.ru/uslugi/sxema-drenazha-i-livnevoj-kanalizaczii">
            <input type="hidden" name="form_subject" value="Заявка с модального окна - Схема дренажа и ливневки">
    ...
    '[[~39? &scheme=`full`]]' => 'https://domozmsk.ru/uslugi/sxema-drenazha-i-livnevoj-kanalizaczii',
    '[[SchemaHome]]' => '<script type="application/ld+json">
{
    ...
    "@graph": [
        ...
        {
            "@type": "WebPage",
            "@id": "https://domozmsk.ru/uslugi/sxema-drenazha-i-livnevoj-kanalizaczii#webpage",
        ...
        {
            "@type": "BreadcrumbList",
            "@id": "https://domozmsk.ru/uslugi/sxema-drenazha-i-livnevoj-kanalizaczii#breadcrumb",
            "itemListElement": [
                {
                    "@type": "ListItem",
                    "position": 1,
        ...
        {
            "@type": "WebApplication",
            "@id": "https://domozmsk.ru/uslugi/sxema-drenazha-i-livnevoj-kanalizaczii#calculator",
            "name": "Калькулятор стоимости ландшафтного дизайна",
            "url": "https://domozmsk.ru/uslugi/sxema-drenazha-i-livnevoj-kanalizaczii#kviz",
        ...
        {
            "@type": "Service",
            "@id": "https://domozmsk.ru/uslugi/sxema-drenazha-i-livnevoj-kanalizaczii#service",
        ...
        },
        {
            ...
            "@id": "https://domozmsk.ru/uslugi/sxema-drenazha-i-livnevoj-kanalizaczii#nav",
            "name": "Главное меню",
            "hasPart": [
                {
                    "@type": "SiteNavigationElement",
                    "name": "Услуги",
                    "url": "https://domozmsk.ru/uslugi/sxema-drenazha-i-livnevoj-kanalizaczii#vidy"
                },
                {
                    "@type": "SiteNavigationElement",
                    "name": "Цены",
