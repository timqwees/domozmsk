<?php if(time() > 1789472958){return null;} return array (
...
',
    ...
    array (
      0 => 'the_link',
      1 => 'https://domozmsk.ru/uslugi/asphalting/',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
  ...
  },
  {
    ...
    array (
      0 => 'baner_h1',
      1 => 'Асфальтирование: благоустройство и покрытие',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
    ...
    array (
      0 => 'fy_block',
      1 => '<h2>Преимущества асфальтирования в нашей компании</h2>
...
',
    ...
    array (
      0 => 'baner_img',
      1 => '[{"MIGX_id":"1","img":"\\/assets\\/img\\/uslugi\\/1-7.jpg","img_mob":"\\/assets\\/img\\/uslugi\\/1-7.jpg"}]',
      2 => 'default',
      3 => NULL,
      4 => 'migx',
    ),
    ...
    array (
      0 => 'baner_des',
      1 => 'Мы выполняем асфальтирование под ключ для частных и коммерческих объектов, создавая ровные, прочные и долговечные покрытия, которые выдерживают интенсивные нагрузки, сохраняют привлекательный внешний вид на протяжении многих лет и не требуют частого ремонта.',
      2 => 'default',
      3 => NULL,
      4 => 'richtext',
    ),
...
{/ignore}
    ...
    '_jscripts' => 
    array (
      0 => '<script>window.addEventListener(\'DOMContentLoaded\', () => FetchIt.create({"action":"070cab3b8f0acaa298be32e93ae6d8fe","assetsUrl":"\\/assets\\/components\\/fetchit\\/","actionUrl":"\\/assets\\/components\\/fetchit\\/action.php","inputInvalidClass":"is-invalid","customInvalidClass":"","clearFieldsOnSuccess":true,"defaultNotifier":true,"pageId":19}));</script>',
      1 => '<script>window.addEventListener(\'DOMContentLoaded\', () => FetchIt.create({"action":"5b4338599cb530c4f36ba76d3d9ca4ab","assetsUrl":"\\/assets\\/components\\/fetchit\\/","actionUrl":"\\/assets\\/components\\/fetchit\\/action.php","inputInvalidClass":"is-invalid","customInvalidClass":"","clearFieldsOnSuccess":true,"defaultNotifier":true,"pageId":19}));</script>',
      2 => '<script>window.addEventListener(\'DOMContentLoaded\', () => FetchIt.create({"action":"5afc876e84af682ffb0fbf1cb5774fe6","assetsUrl":"\\/assets\\/components\\/fetchit\\/","actionUrl":"\\/assets\\/components\\/fetchit\\/action.php","inputInvalidClass":"is-invalid","customInvalidClass":"","clearFieldsOnSuccess":true,"defaultNotifier":true,"pageId":19}));</script>',
    ),
    '_loadedjscripts' => 
    array (
      '<script>window.addEventListener(\'DOMContentLoaded\', () => FetchIt.create({"action":"070cab3b8f0acaa298be32e93ae6d8fe","assetsUrl":"\\/assets\\/components\\/fetchit\\/","actionUrl":"\\/assets\\/components\\/fetchit\\/action.php","inputInvalidClass":"is-invalid","customInvalidClass":"","clearFieldsOnSuccess":true,"defaultNotifier":true,"pageId":19}));</script>' => true,
      '<script>window.addEventListener(\'DOMContentLoaded\', () => FetchIt.create({"action":"5b4338599cb530c4f36ba76d3d9ca4ab","assetsUrl":"\\/assets\\/components\\/fetchit\\/","actionUrl":"\\/assets\\/components\\/fetchit\\/action.php","inputInvalidClass":"is-invalid","customInvalidClass":"","clearFieldsOnSuccess":true,"defaultNotifier":true,"pageId":19}));</script>' => true,
      '<script>window.addEventListener(\'DOMContentLoaded\', () => FetchIt.create({"action":"5afc876e84af682ffb0fbf1cb5774fe6","assetsUrl":"\\/assets\\/components\\/fetchit\\/","actionUrl":"\\/assets\\/components\\/fetchit\\/action.php","inputInvalidClass":"is-invalid","customInvalidClass":"","clearFieldsOnSuccess":true,"defaultNotifier":true,"pageId":19}));</script>' => true,
    ),
  ),
  'contentType' => 
  array (
...
{/ignore}',
    '[[phpthumbon?input=`/assets/img/uslugi/1-7.jpg`&options=`w=768&f=webp&q=75`&pdoTools=`55053ef9b69cebff4aa38fdaf5fb6939`]]' => '/assets/cache_image/assets/img/uslugi/1-7_768x0_eb8.webp',
    '[[phpthumbon?input=`/assets/img/uslugi/1-7.jpg`&options=`w=1920&f=webp&q=75`&pdoTools=`982de572a9a3f8c3e53ea52b57697139`]]' => '/assets/cache_image/assets/img/uslugi/1-7_1920x0_aa5.webp',
    '[[FetchIt?form=`@INLINE <form method="POST" class="md:col-span-3 p-6 bg-white">
                                    ...
                                    <div class="flex flex-col gap-4 text-black">
                                        <input name="Имя" type="text" placeholder="Ваше имя" required
                                            ...
                                            style="color:black">
                                        <input type="tel" name="Телефон" placeholder="(999) 999-99-99" maxlength="18" inputmode="numeric" autocomplete="tel" data-type-phone class="!text-black w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#558255] focus:border-transparent transition" required>
                                        <input type="hidden" name="Страница" value="https://domozmsk.ru/uslugi/asphalting/">
                                        <input type="hidden" name="Название страницы" value="Асфальтирование">
                                        <button type="submit"
                                                class="w-full bg-[#558255] hover:bg-[#3d5c3d] text-white py-3.5 rounded-xl text-base font-bold transition shadow-md mt-2">
                                                Получить расчет
                                        </button>
    ...
    '[[phpthumbon?input=`assets/img/фото_асфальтирование/фотки/010.jpg`&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`42ad01260272c2639911dd008baa3b0d`]]' => '/assets/cache_image/assets/img/фото_асфальтирование/фотки/010_800x600_af0.webp',
    '[[phpthumbon?input=`assets/img/фото_асфальтирование/фотки/09.jpg`&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`c4b582bdd9db99e1e622e3345a86c3ac`]]' => '/assets/cache_image/assets/img/фото_асфальтирование/фотки/09_800x600_af0.webp',
    '[[phpthumbon?input=`assets/img/фото_асфальтирование/фотки/011.jpg`&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`23d1f33cdb9aaa32169232d5284af676`]]' => '/assets/cache_image/assets/img/фото_асфальтирование/фотки/011_800x600_af0.webp',
...
`&toPlaceholder=``&parents=`0`&includeContent=``&includeTVs=`img_cat,price_cat,link_cat,categoryi`&prepareTVs=`1`&processTVs=``&tvPrefix=``&tvFilters=``&tvFiltersAndDelimiter=`,`&tvFiltersOrDelimiter=`||`&where=``&showUnpublished=``&showDeleted=``&showHidden=`1`&hideContainers=``&context=``&idx=``&first=``&last=``&tplFirst=``&tplLast=``&tplOdd=``&tplWrapper=``&wrapIfEmpty=``&totalVar=`total`&resources=`93,94,95`&tplCondition=``&tplOperator=`==`&conditionalTpls=``&select=``&toSeparatePlaceholders=``&loadModels=``&scheme=``&useWeblinkUrl=``]]' => '<div class="overflow-hidden service-card group border border-gray-200 bg-white shadow-sm rounded-2xl"
                        itemscope itemtype="https://schema.org/Service">
                        <meta itemprop="name" content="Устройство основания под асфальт в Москве">
                        <meta itemprop="description"
                            content="Предложение компании ландшафтного дизайна в Москве и МО - Устройство основания под асфальт в Москве под ключ в Подмосковье. Цены, сроки и стоимость работ.">
                                                <div class="relative h-52 rounded-2xl">
                            <div class="swiper swiper-type-one w-full h-full">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img decoding="async" itemprop="image" alt="Устройство основания под асфальт в Москве" fetchpriority="high" src="/assets/cache_image/assets/img/фото_асфальтирование/фотки/010_800x600_af0.webp" class="w-full h-full object-cover" width="800" height="600">
                                    </div>
                                </div>
                            </div>
                            <div
                                class="absolute bottom-0 left-0 right-0 z-20 p-4 bg-gradient-to-t from-black/70 to-transparent">
                                                                <h3 class="mt-1 font-semibold text-white text-lg text-start" itemprop="name">
                                    Устройство основания под асфальт в Москве                                </h3>
                            </div>
                        </div>
...
<div class="overflow-hidden service-card group border border-gray-200 bg-white shadow-sm rounded-2xl"
                        itemscope itemtype="https://schema.org/Service">
                        <meta itemprop="name" content="Ремонт и восстановление асфальта">
                        <meta itemprop="description"
                            content="Предложение компании ландшафтного дизайна в Москве и МО - Ремонт и восстановление асфальта под ключ в Подмосковье. Цены, сроки и стоимость работ.">
                                                <div class="relative h-52 rounded-2xl">
                            <div class="swiper swiper-type-one w-full h-full">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img decoding="async" itemprop="image" alt="Ремонт и восстановление асфальта" loading="lazy" src="/assets/cache_image/assets/img/фото_асфальтирование/фотки/09_800x600_af0.webp" class="w-full h-full object-cover" width="800" height="600">
                                    </div>
                                </div>
                            </div>
                            <div
                                class="absolute bottom-0 left-0 right-0 z-20 p-4 bg-gradient-to-t from-black/70 to-transparent">
                                                                <h3 class="mt-1 font-semibold text-white text-lg text-start" itemprop="name">
                                    Ремонт и восстановление асфальта                                </h3>
                            </div>
                        </div>
...
<div class="overflow-hidden service-card group border border-gray-200 bg-white shadow-sm rounded-2xl"
                        itemscope itemtype="https://schema.org/Service">
                        <meta itemprop="name" content="Асфальтирование участков и парковок">
                        <meta itemprop="description"
                            content="Предложение компании ландшафтного дизайна в Москве и МО - Асфальтирование участков и парковок под ключ в Подмосковье. Цены, сроки и стоимость работ.">
                                                <div class="relative h-52 rounded-2xl">
                            <div class="swiper swiper-type-one w-full h-full">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img decoding="async" itemprop="image" alt="Асфальтирование участков и парковок" loading="lazy" src="/assets/cache_image/assets/img/фото_асфальтирование/фотки/011_800x600_af0.webp" class="w-full h-full object-cover" width="800" height="600">
                                    </div>
                                </div>
                            </div>
                            <div
                                class="absolute bottom-0 left-0 right-0 z-20 p-4 bg-gradient-to-t from-black/70 to-transparent">
                                                                <h3 class="mt-1 font-semibold text-white text-lg text-start" itemprop="name">
                                    Асфальтирование участков и парковок                                </h3>
                            </div>
                        </div>

                    </div>',
    '[[phpthumbon?input=`assets/img/фото_асфальтирование/фотки/01.jpg`&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`2cd32420f68d3b302d5b6d7fec5f90f5`]]' => '/assets/cache_image/assets/img/фото_асфальтирование/фотки/01_800x600_af0.webp',
    '[[phpthumbon?input=`assets/img/фото_асфальтирование/фотки/01.jpg`&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`21351749d398e835a8ca8a56ea3db022`]]' => '/assets/cache_image/assets/img/фото_асфальтирование/фотки/01_800x600_af0.webp',
    '[[phpthumbon?input=`assets/img/фото_асфальтирование/фотки/010.jpg`&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`c412bd1a44780384e60534e133bd831a`]]' => '/assets/cache_image/assets/img/фото_асфальтирование/фотки/010_800x600_af0.webp',
    '[[phpthumbon?input=`assets/img/фото_асфальтирование/фотки/010.jpg`&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`3d7f8fbeedeb8cf4da5bb5bfb43cafb5`]]' => '/assets/cache_image/assets/img/фото_асфальтирование/фотки/010_800x600_af0.webp',
    '[[phpthumbon?input=`assets/img/фото_асфальтирование/фотки/011.jpg`&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`2b8edba298f1d8a6dd02bd8b1745ffd3`]]' => '/assets/cache_image/assets/img/фото_асфальтирование/фотки/011_800x600_af0.webp',
    '[[phpthumbon?input=`assets/img/фото_асфальтирование/фотки/011.jpg`&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`ce2c7173ef58d61218b14c1a4cc8a885`]]' => '/assets/cache_image/assets/img/фото_асфальтирование/фотки/011_800x600_af0.webp',
    '[[phpthumbon?input=`assets/img/фото_асфальтирование/фотки/02.jpg`&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`b823bc0b8170ce336f39c34e991a6ef0`]]' => '/assets/cache_image/assets/img/фото_асфальтирование/фотки/02_800x600_af0.webp',
    '[[phpthumbon?input=`assets/img/фото_асфальтирование/фотки/02.jpg`&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`83e75f99c1b4c2016f2538b0a1eb5018`]]' => '/assets/cache_image/assets/img/фото_асфальтирование/фотки/02_800x600_af0.webp',
    '[[phpthumbon?input=`assets/img/фото_асфальтирование/фотки/03.jpg`&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`0a302f08942d67843cc4267827ec10b0`]]' => '/assets/cache_image/assets/img/фото_асфальтирование/фотки/03_800x600_af0.webp',
    '[[phpthumbon?input=`assets/img/фото_асфальтирование/фотки/03.jpg`&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`977556665b754bc7a8aeb845d3215837`]]' => '/assets/cache_image/assets/img/фото_асфальтирование/фотки/03_800x600_af0.webp',
    '[[phpthumbon?input=`assets/img/фото_асфальтирование/фотки/04.jpg`&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`a83e94802b38b592a7e5c60a95eea5b5`]]' => '/assets/cache_image/assets/img/фото_асфальтирование/фотки/04_800x600_af0.webp',
    '[[phpthumbon?input=`assets/img/фото_асфальтирование/фотки/04.jpg`&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`3bcf4d4bc7741ecedb05b2fc07d6be96`]]' => '/assets/cache_image/assets/img/фото_асфальтирование/фотки/04_800x600_af0.webp',
    '[[phpthumbon?input=`assets/img/фото_асфальтирование/фотки/05.jpg`&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`cbbb32e799c5c10d879dbf02f1a0139b`]]' => '/assets/cache_image/assets/img/фото_асфальтирование/фотки/05_800x600_af0.webp',
    '[[phpthumbon?input=`assets/img/фото_асфальтирование/фотки/05.jpg`&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`9cc407b102dd17397eae6dab080e5b2b`]]' => '/assets/cache_image/assets/img/фото_асфальтирование/фотки/05_800x600_af0.webp',
    '[[phpthumbon?input=`assets/img/фото_асфальтирование/фотки/06.jpg`&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`77f7fe4a19d211198d40b4a1f4a27c18`]]' => '/assets/cache_image/assets/img/фото_асфальтирование/фотки/06_800x600_af0.webp',
    '[[phpthumbon?input=`assets/img/фото_асфальтирование/фотки/06.jpg`&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`7d17425b00c15968194a25cd3ba8fe5f`]]' => '/assets/cache_image/assets/img/фото_асфальтирование/фотки/06_800x600_af0.webp',
    '[[phpthumbon?input=`assets/img/фото_асфальтирование/фотки/07.jpg`&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`6793c62aecd961cc5eae43152942ce61`]]' => '/assets/cache_image/assets/img/фото_асфальтирование/фотки/07_800x600_af0.webp',
    '[[phpthumbon?input=`assets/img/фото_асфальтирование/фотки/07.jpg`&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`fa8363c6e03695220345d4d7bf9cd4c9`]]' => '/assets/cache_image/assets/img/фото_асфальтирование/фотки/07_800x600_af0.webp',
    '[[phpthumbon?input=`assets/img/фото_асфальтирование/фотки/08.jpg`&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`da2ed43c6db64a1b0b531fa1fa5b0740`]]' => '/assets/cache_image/assets/img/фото_асфальтирование/фотки/08_800x600_af0.webp',
    '[[phpthumbon?input=`assets/img/фото_асфальтирование/фотки/08.jpg`&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`2b9c8e76643173bbba8116dff52c86c2`]]' => '/assets/cache_image/assets/img/фото_асфальтирование/фотки/08_800x600_af0.webp',
...
',
    '[[FetchIt?form=`@INLINE <form id="pom-modal" class="modal-form">
            ...
            </form>`&snippet=`FormIt`&actionUrl=`[[+assetsUrl]]action.php`&clearFieldsOnSuccess=`1`&hooks=`email`&emailTo=`Domoz.77@yandex.ru`&emailSubject=`Заявка с модального окна - Асфальтирование`&successMessage=`<div class="modal-success"><svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#558255" stroke-width="2"><path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg><h3>Спасибо!</h3><p>Мы свяжемся с вами в ближайшее время</p></div>`&validate=`af_name:required:minLength=2,af_phone:required,af_email:required:email`]]' => '<form data-fetchit="5afc876e84af682ffb0fbf1cb5774fe6" method="post" id="pom-modal" class="modal-form">
            <input name="workemail" hidden>
            <input name="page" hidden value="Асфальтирование">
            <input name="url" hidden value="https://domozmsk.ru/uslugi/asphalting/">
            <input type="hidden" name="form_subject" value="Заявка с модального окна - Асфальтирование">
    ...
    '[[~19? &scheme=`full`]]' => 'https://domozmsk.ru/uslugi/asphalting/',
    '[[SchemaHome]]' => '<script type="application/ld+json">
{
    ...
    "@graph": [
        ...
        {
            "@type": "WebPage",
            "@id": "https://domozmsk.ru/uslugi/asphalting/#webpage",
        ...
        {
            "@type": "BreadcrumbList",
            "@id": "https://domozmsk.ru/uslugi/asphalting/#breadcrumb",
            "itemListElement": [
                {
                    "@type": "ListItem",
                    "position": 1,
        ...
        {
            "@type": "WebApplication",
            "@id": "https://domozmsk.ru/uslugi/asphalting/#calculator",
            "name": "Калькулятор стоимости ландшафтного дизайна",
            "url": "https://domozmsk.ru/uslugi/asphalting/#kviz",
        ...
        {
            "@type": "ItemList",
            "@id": "https://domozmsk.ru/uslugi/asphalting/#services",
            ...
            "itemListElement": [
                {
                    ...
                    "item": {
                        "@type": "Service",
                        "name": "Асфальтирование участков и парковок",
                        "url": "https://domozmsk.ru/uslugi/asphalting/asfaltirovanie-uchastkov-i-parkovok",
                        "provider": {
                            "@id": "https://domozmsk.ru/#organization"
                        },
                        "areaServed": [
                ...
                },
                {
                    ...
                    "item": {
                        "@type": "Service",
                        "name": "Ремонт и восстановление асфальта",
                        "url": "https://domozmsk.ru/uslugi/asphalting/remont-i-vosstanovlenie-asfalta",
                        "provider": {
                            "@id": "https://domozmsk.ru/#organization"
                        },
                        "areaServed": [
                ...
                },
                {
                    ...
                    "item": {
                        "@type": "Service",
                        "name": "Устройство основания под асфальт в Москве",
                        "url": "https://domozmsk.ru/uslugi/asphalting/ustrojstvo-osnovaniya-pod-asfalt",
                        "provider": {
                            "@id": "https://domozmsk.ru/#organization"
                        },
                        "areaServed": [
        ...
        {
            "@type": "Service",
            "@id": "https://domozmsk.ru/uslugi/asphalting/#service",
        ...
        },
        {
            ...
            "@id": "https://domozmsk.ru/uslugi/asphalting/#nav",
            "name": "Главное меню",
            "hasPart": [
                {
                    "@type": "SiteNavigationElement",
                    "name": "Услуги",
                    "url": "https://domozmsk.ru/uslugi/asphalting/#vidy"
                },
                {
                    "@type": "SiteNavigationElement",
                    "name": "Цены",
        ...
        {
            "@type": "FAQPage",
            "@id": "https://domozmsk.ru/uslugi/asphalting/#faq",
            "mainEntity": [
                {
                    "@type": "Question",
                    "name": "Сколько служит асфальтовое покрытие?",
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "При соблюдении технологии укладки и правильной подготовке основания срок службы покрытия может составлять 10–20 лет и более."
                    }
                },
                {
                    "@type": "Question",
                    "name": "Можно ли укладывать асфальт на существующее покрытие?",
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "Да, при условии оценки состояния старого основания и соблюдения технологии ремонта."
                    }
                },
                {
                    "@type": "Question",
                    "name": "Какая минимальная площадь объекта для выполнения работ?",
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "Мы работаем как с небольшими частными территориями, так и с крупными коммерческими объектами."
                    }
                },
                {
                    "@type": "Question",
                    "name": "От чего зависит стоимость асфальтирования?",
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "На цену влияют площадь участка, состояние основания, толщина покрытия, объем подготовительных работ и удаленность объекта."
                    }
                }
            ]
        }
