<?php if(time() > 1789463995){return null;} return array (
  ...
  array (
    ...
    array (
      0 => 'the_link',
      1 => 'https://domozmsk.ru/uslugi/design-automatic-irrigation-system',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
    ...
    array (
      0 => 'baner_h1',
      1 => 'Проектирование системы автополива',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
    ...
    array (
      0 => 'img_cat',
      1 => '/assets/img/uslugi/avtopoliv/noroot12.png',
      2 => 'default',
      3 => NULL,
      4 => 'image',
    ),
...
<h4>Инженерная точность и надёжность</h4>

<p>Мы выполняем проектирование систем автополива для участков любой площади и сложности. Каждый проект системы автоматического полива создаётся на основе точных гидравлических расчётов и особенностей рельефа, чтобы обеспечить равномерное увлажнение без перерасхода воды</p>
</div>

<div class="fy_grid-block">
<h4>Комплексный подход</h4>

<p>Проект автополива участка разрабатывается в составе общего благоустройства — с учётом газонов, клумб, живых изгородей и деревьев. Мы подбираем оборудование и трассы так, чтобы система была эффективной, незаметной и долговечной.</p>
</div>

<div class="fy_grid-block">
<h4>Индивидуальные решения</h4>

<p>DOM OZ создаёт проект автополива газона, сада, теплицы или всего участка. Мы используем разные типы распылителей и контроллеров, чтобы система идеально соответствовала растениям и условиям эксплуатации.</p>
</div>

<div class="fy_grid-block">
<h4>Прозрачная стоимость</h4>

<p>Стоимость проектирования системы автополива рассчитывается заранее и фиксируется в договоре. Мы предоставляем точную смету и полный перечень оборудования, чтобы клиент понимал, за что платит.</p>
</div>
</div>
',
      2 => 'default',
    ...
    array (
      0 => 'baner_img',
      1 => '[{"MIGX_id":"1","img":"assets\\/img\\/uslugi\\/avtopoliv\\/autopoluv.PNG","img_mob":"assets\\/img\\/uslugi\\/avtopoliv\\/autopoluv.PNG"}]',
      2 => 'default',
      3 => NULL,
      4 => 'migx',
    ),
    ...
    array (
      0 => 'baner_des',
      1 => 'Создаём умные инженерные решения,<br />
которые заботятся о растениях и сохраняют<br />
идеальный ландшафт без лишних усилий.',
      2 => 'default',
      3 => NULL,
      4 => 'richtext',
    ),
...
{/ignore}
    ...
    '_jscripts' => 
    array (
      0 => '<script>window.addEventListener(\'DOMContentLoaded\', () => FetchIt.create({"action":"070cab3b8f0acaa298be32e93ae6d8fe","assetsUrl":"\\/assets\\/components\\/fetchit\\/","actionUrl":"\\/assets\\/components\\/fetchit\\/action.php","inputInvalidClass":"is-invalid","customInvalidClass":"","clearFieldsOnSuccess":true,"defaultNotifier":true,"pageId":26}));</script>',
      1 => '<script>window.addEventListener(\'DOMContentLoaded\', () => FetchIt.create({"action":"5b4338599cb530c4f36ba76d3d9ca4ab","assetsUrl":"\\/assets\\/components\\/fetchit\\/","actionUrl":"\\/assets\\/components\\/fetchit\\/action.php","inputInvalidClass":"is-invalid","customInvalidClass":"","clearFieldsOnSuccess":true,"defaultNotifier":true,"pageId":26}));</script>',
      2 => '<script>window.addEventListener(\'DOMContentLoaded\', () => FetchIt.create({"action":"6f10f8ab33de5607994f8bd8ad913d0a","assetsUrl":"\\/assets\\/components\\/fetchit\\/","actionUrl":"\\/assets\\/components\\/fetchit\\/action.php","inputInvalidClass":"is-invalid","customInvalidClass":"","clearFieldsOnSuccess":true,"defaultNotifier":true,"pageId":26}));</script>',
    ),
    '_loadedjscripts' => 
    array (
      '<script>window.addEventListener(\'DOMContentLoaded\', () => FetchIt.create({"action":"070cab3b8f0acaa298be32e93ae6d8fe","assetsUrl":"\\/assets\\/components\\/fetchit\\/","actionUrl":"\\/assets\\/components\\/fetchit\\/action.php","inputInvalidClass":"is-invalid","customInvalidClass":"","clearFieldsOnSuccess":true,"defaultNotifier":true,"pageId":26}));</script>' => true,
      '<script>window.addEventListener(\'DOMContentLoaded\', () => FetchIt.create({"action":"5b4338599cb530c4f36ba76d3d9ca4ab","assetsUrl":"\\/assets\\/components\\/fetchit\\/","actionUrl":"\\/assets\\/components\\/fetchit\\/action.php","inputInvalidClass":"is-invalid","customInvalidClass":"","clearFieldsOnSuccess":true,"defaultNotifier":true,"pageId":26}));</script>' => true,
      '<script>window.addEventListener(\'DOMContentLoaded\', () => FetchIt.create({"action":"6f10f8ab33de5607994f8bd8ad913d0a","assetsUrl":"\\/assets\\/components\\/fetchit\\/","actionUrl":"\\/assets\\/components\\/fetchit\\/action.php","inputInvalidClass":"is-invalid","customInvalidClass":"","clearFieldsOnSuccess":true,"defaultNotifier":true,"pageId":26}));</script>' => true,
    ),
  ),
  'contentType' => 
  array (
...
{/ignore}',
    '[[phpthumbon?input=`assets/img/uslugi/avtopoliv/autopoluv.PNG`&options=`w=768&f=webp&q=75`&pdoTools=`8010dadee0fcd7d1a7269ee2bd51b551`]]' => '/assets/cache_image/assets/img/uslugi/avtopoliv/autopoluv_768x0_eb8.webp',
    '[[phpthumbon?input=`assets/img/uslugi/avtopoliv/autopoluv.PNG`&options=`w=1920&f=webp&q=75`&pdoTools=`702493c0b7d6f901464c94826c8ef800`]]' => '/assets/cache_image/assets/img/uslugi/avtopoliv/autopoluv_1920x0_aa5.webp',
    '[[FetchIt?form=`@INLINE <form method="POST" class="md:col-span-3 p-6 bg-white">
                                    ...
                                    <div class="flex flex-col gap-4 text-black">
                                        <input name="Имя" type="text" placeholder="Ваше имя" required
                                            ...
                                            style="color:black">
                                        <input type="tel" name="Телефон" placeholder="(999) 999-99-99" maxlength="18" inputmode="numeric" autocomplete="tel" data-type-phone class="!text-black w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#558255] focus:border-transparent transition" required>
                                        <input type="hidden" name="Страница" value="https://domozmsk.ru/uslugi/design-automatic-irrigation-system">
                                        <input type="hidden" name="Название страницы" value="Проектирование системы автополива">
                                        <button type="submit"
                                                class="w-full bg-[#558255] hover:bg-[#3d5c3d] text-white py-3.5 rounded-xl text-base font-bold transition shadow-md mt-2">
                                                Получить расчет
                                        </button>
    ...
    '[[phpthumbon?input=``&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`58a5444d2109b060558bcd2cc4265cd1`]]' => '/assets/cache_image/noimage_800x600_af0.webp',
    '[[phpthumbon?input=``&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`3a2ddf485fd625bc6ceecebc834547af`]]' => '/assets/cache_image/noimage_800x600_af0.webp',
    '[[phpthumbon?input=``&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`92ebd07aff7d1149f9bda07369c60ee2`]]' => '/assets/cache_image/noimage_800x600_af0.webp',
    '[[phpthumbon?input=``&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`30d12f4a7149d6841742eaeb6e8b241d`]]' => '/assets/cache_image/noimage_800x600_af0.webp',
    '[[phpthumbon?input=`assets/img/Партнерская программа/Одинцово_13 - Фото (1).jpg`&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`02785dd06a4fd6789d5d0c8a8426f0fb`]]' => '/assets/cache_image/assets/img/Партнерская программа/Одинцово_13 - Фото (1)_800x600_af0.webp',
    '[[phpthumbon?input=``&options=`w=800&h=600&zc=1&f=webp&q=75`&pdoTools=`8b2dbaf725ec9262e1e19e0742d8e3c4`]]' => '/assets/cache_image/noimage_800x600_af0.webp',
...
',
    '[[FetchIt?form=`@INLINE <form id="pom-modal" class="modal-form">
            ...
            </form>`&snippet=`FormIt`&actionUrl=`[[+assetsUrl]]action.php`&clearFieldsOnSuccess=`1`&hooks=`email`&emailTo=`Domoz.77@yandex.ru`&emailSubject=`Заявка с модального окна - Проектирование системы автополива`&successMessage=`<div class="modal-success"><svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#558255" stroke-width="2"><path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg><h3>Спасибо!</h3><p>Мы свяжемся с вами в ближайшее время</p></div>`&validate=`af_name:required:minLength=2,af_phone:required,af_email:required:email`]]' => '<form data-fetchit="6f10f8ab33de5607994f8bd8ad913d0a" method="post" id="pom-modal" class="modal-form">
            <input name="workemail" hidden>
            <input name="page" hidden value="Проектирование системы автополива">
            <input name="url" hidden value="https://domozmsk.ru/uslugi/design-automatic-irrigation-system">
            <input type="hidden" name="form_subject" value="Заявка с модального окна - Проектирование системы автополива">
    ...
    '[[~26? &scheme=`full`]]' => 'https://domozmsk.ru/uslugi/design-automatic-irrigation-system',
    '[[SchemaHome]]' => '<script type="application/ld+json">
{
    ...
    "@graph": [
        ...
        {
            "@type": "WebPage",
            "@id": "https://domozmsk.ru/uslugi/design-automatic-irrigation-system#webpage",
        ...
        {
            "@type": "BreadcrumbList",
            "@id": "https://domozmsk.ru/uslugi/design-automatic-irrigation-system#breadcrumb",
            "itemListElement": [
                {
                    "@type": "ListItem",
                    "position": 1,
        ...
        {
            "@type": "WebApplication",
            "@id": "https://domozmsk.ru/uslugi/design-automatic-irrigation-system#calculator",
            "name": "Калькулятор стоимости ландшафтного дизайна",
            "url": "https://domozmsk.ru/uslugi/design-automatic-irrigation-system#kviz",
        ...
        {
            "@type": "Service",
            "@id": "https://domozmsk.ru/uslugi/design-automatic-irrigation-system#service",
        ...
        },
        {
            ...
            "@id": "https://domozmsk.ru/uslugi/design-automatic-irrigation-system#nav",
            "name": "Главное меню",
            "hasPart": [
                {
                    "@type": "SiteNavigationElement",
                    "name": "Услуги",
                    "url": "https://domozmsk.ru/uslugi/design-automatic-irrigation-system#vidy"
                },
                {
                    "@type": "SiteNavigationElement",
                    "name": "Цены",
