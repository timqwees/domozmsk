<?php if(time() > 1789463898){return null;} return array (
  ...
  array (
    ...
    array (
      0 => 'img_cat',
      1 => 'assets/img/Партнерская программа/Одинцово_13 - Фото (1).jpg',
      2 => 'default',
      3 => NULL,
      4 => 'image',
    ),
    'history_hero_title' => 
    array (
      0 => 'history_hero_title',
      1 => 'Партнерская программа компании “Дом&nbsp;Оз”',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
    ...
    array (
      0 => 'history_hero_desc',
      1 => 'Если вы работаете в сфере строительства, архитектуры, дизайна или благоустройства территорий и ищете надежного партнера, будем рады знакомству',
      2 => 'default',
      3 => NULL,
      4 => 'textarea',
    ),
    ...
    array (
      0 => 'the_link',
      1 => 'https://domozmsk.ru/partnerskaya-programma',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
...
{/ignore}
    ...
    '_jscripts' => 
    array (
      0 => '<script>window.addEventListener(\'DOMContentLoaded\', () => FetchIt.create({"action":"5b4338599cb530c4f36ba76d3d9ca4ab","assetsUrl":"\\/assets\\/components\\/fetchit\\/","actionUrl":"\\/assets\\/components\\/fetchit\\/action.php","inputInvalidClass":"is-invalid","customInvalidClass":"","clearFieldsOnSuccess":true,"defaultNotifier":true,"pageId":52}));</script>',
      1 => '<script>window.addEventListener(\'DOMContentLoaded\', () => FetchIt.create({"action":"8a15190e71cb1ccbc02ebe6684bb99d2","assetsUrl":"\\/assets\\/components\\/fetchit\\/","actionUrl":"\\/assets\\/components\\/fetchit\\/action.php","inputInvalidClass":"is-invalid","customInvalidClass":"","clearFieldsOnSuccess":true,"defaultNotifier":true,"pageId":52}));</script>',
    ),
    '_loadedjscripts' => 
    array (
      '<script>window.addEventListener(\'DOMContentLoaded\', () => FetchIt.create({"action":"5b4338599cb530c4f36ba76d3d9ca4ab","assetsUrl":"\\/assets\\/components\\/fetchit\\/","actionUrl":"\\/assets\\/components\\/fetchit\\/action.php","inputInvalidClass":"is-invalid","customInvalidClass":"","clearFieldsOnSuccess":true,"defaultNotifier":true,"pageId":52}));</script>' => true,
      '<script>window.addEventListener(\'DOMContentLoaded\', () => FetchIt.create({"action":"8a15190e71cb1ccbc02ebe6684bb99d2","assetsUrl":"\\/assets\\/components\\/fetchit\\/","actionUrl":"\\/assets\\/components\\/fetchit\\/action.php","inputInvalidClass":"is-invalid","customInvalidClass":"","clearFieldsOnSuccess":true,"defaultNotifier":true,"pageId":52}));</script>' => true,
    ),
  ),
  'contentType' => 
  array (
...
',
    '[[FetchIt?form=`@INLINE <form id="pom-modal" class="modal-form">
            ...
            </form>`&snippet=`FormIt`&actionUrl=`[[+assetsUrl]]action.php`&clearFieldsOnSuccess=`1`&hooks=`email`&emailTo=`Domoz.77@yandex.ru`&emailSubject=`Заявка с модального окна - Партнерская программа`&successMessage=`<div class="modal-success"><svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#558255" stroke-width="2"><path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg><h3>Спасибо!</h3><p>Мы свяжемся с вами в ближайшее время</p></div>`&validate=`af_name:required:minLength=2,af_phone:required,af_email:required:email`]]' => '<form data-fetchit="8a15190e71cb1ccbc02ebe6684bb99d2" method="post" id="pom-modal" class="modal-form">
            <input name="workemail" hidden>
            <input name="page" hidden value="Партнерская программа">
            <input name="url" hidden value="https://domozmsk.ru/partnerskaya-programma">
            <input type="hidden" name="form_subject" value="Заявка с модального окна - Партнерская программа">
    ...
    '[[~52? &scheme=`full`]]' => 'https://domozmsk.ru/partnerskaya-programma',
    '[[SchemaHome]]' => '<script type="application/ld+json">
{
    ...
    "@graph": [
        ...
        {
            "@type": "WebPage",
            "@id": "https://domozmsk.ru/partnerskaya-programma#webpage",
            "url": "https://domozmsk.ru/partnerskaya-programma",
        ...
        {
            "@type": "BreadcrumbList",
            "@id": "https://domozmsk.ru/partnerskaya-programma#breadcrumb",
            "itemListElement": [
                {
                    "@type": "ListItem",
                    "position": 1,
        ...
        {
            "@type": "WebApplication",
            "@id": "https://domozmsk.ru/partnerskaya-programma#calculator",
            "name": "Калькулятор стоимости ландшафтного дизайна",
            "url": "https://domozmsk.ru/partnerskaya-programma#kviz",
        ...
        {
            "@type": "Service",
            "@id": "https://domozmsk.ru/partnerskaya-programma#service",
        ...
        },
        {
            ...
            "@id": "https://domozmsk.ru/partnerskaya-programma#nav",
            "name": "Главное меню",
            "hasPart": [
                {
                    "@type": "SiteNavigationElement",
                    "name": "Услуги",
                    "url": "https://domozmsk.ru/partnerskaya-programma#vidy"
                },
                {
                    "@type": "SiteNavigationElement",
                    "name": "Цены",
