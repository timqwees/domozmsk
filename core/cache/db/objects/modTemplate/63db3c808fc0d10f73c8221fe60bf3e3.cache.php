    ...
    <section class="fy politiki">
      <div class="ar-container">
        ...
        <p> <br />1. Общие положения
              ...
              <br />1.2. Настоящая политика Оператора в отношении обработки персональных данных (далее — Политика) применяется ко всей информации, которую Оператор может получить о посетителях веб-сайта https://domozmsk.ru.
              ...
              <br />2.3. Веб-сайт — совокупность графических и информационных материалов, а также программ для ЭВМ и баз данных, обеспечивающих их доступность в сети интернет по сетевому адресу https://domozmsk.ru.
              ...
              <br />2.8. Персональные данные — любая информация, относящаяся прямо или косвенно к определенному или определяемому Пользователю веб-сайта https://domozmsk.ru.
              ...
              <br />2.10. Пользователь — любой посетитель веб-сайта https://domozmsk.ru.
              ...
              <br />6. Цели обработки персональных данных</p>
            
              <ul>
                <li data-list="bullet">Цель обработкипредоставление доступа Пользователю к сервисам, информации и/или материалам, содержащимся на веб-сайтеПерсональные данныефамилия, имя, отчество</li>
                <li data-list="bullet">электронный адрес</li>
                <li data-list="bullet">номера телефонов</li>
                <li data-list="bullet">Правовые основаниядоговоры, заключаемые между оператором и субъектом персональных данных</li>
                <li data-list="bullet">Виды обработки персональных данныхСбор, запись, систематизация, накопление, хранение, уничтожение и обезличивание персональных данных</li>
              </ul>
              <p>7. Условия обработки персональных данных
              ...
              <br />8.3. В случае выявления неточностей в персональных данных, Пользователь может актуализировать их самостоятельно, путем направления Оператору уведомление на адрес электронной почты Оператора DOMOZ.77@yandex.ru с пометкой «Актуализация персональных данных».
              ...
              <br />Пользователь может в любой момент отозвать свое согласие на обработку персональных данных, направив Оператору уведомление посредством электронной почты на электронный адрес Оператора DOMOZ.77@yandex.ru с пометкой «Отзыв согласия на обработку персональных данных».
              ...
              <br />12. Используемые Cookies и сервисы веб-аналитики
              <br />12.1. Администратор использует собственные cookies-файлы в целях обеспечения корректной работы Сайта. Эти Cookies не содержат в себе никакой идентификационной информации, а служат исключительно для сохранения технических настроек Сайта в целях соответствующего корректного отображения при повторных визитах Пользователя.
              <br />Администратор не хранит у себя, не систематизирует и не предоставляет данную техническую информацию, содержащуюся в Cookies Сайта, третьим лицам.
              <br />12.2. Администратор использует специальные сторонние веб‑сервисы для анализа посещений и оценки качества работы Сайта. Поэтому при посещении Сайта имеются технические сведения, собираемые посредством сторонних метрических программ, данные которых передаются третьим лицам.
              <br />На Сайте используются следующие сервисы веб-аналитики, которые самостоятельно в автоматическом режиме собирают технические данные и устанавливают собственные Cookies:
              <br />12.3. Яндекс Метрика – оператор ООО «Яндекс»
              <br />Информация об использовании Пользователем данного Сайта, собранная при помощи Cookies, будет передаваться Яндексу и храниться на серверах Яндекса в РФ и/или в ЕЭЗ. Яндекс будет обрабатывать эту информацию в интересах Администратора для оценки использования Сайта и составления отчетов об активности на Сайте.
              <br />Яндекс обрабатывает эту информацию в порядке, установленном в Условиях использования сервиса Яндекс Метрика — <a href="https://yandex.ru/legal/metrica_termsofuse/">https://yandex.ru/legal/metrica_termsofuse/</a>).
              <br />Согласно п.19 «Условий использования …», доступных по адресу https://yandex.ru/legal/metrica_termsofuse/, все собираемые и хранимые данные Яндекс рассматривает как персональные данные и конфиденциальную информацию. При этом Администратор не имеет абсолютно никакого доступа к данным, позволяющим идентифицировать Пользователя как физическое лицо и/или субъекта персональных данных.
              <br />13. Заключительные положения
              <br />13.1. Пользователь может получить любые разъяснения по интересующим вопросам, касающимся обработки его персональных данных, обратившись к Оператору с помощью электронной почты DOMOZ.77@yandex.ru.
              <br />13.2. В данном документе будут отражены любые изменения политики обработки персональных данных Оператором. Политика действует бессрочно до замены ее новой версией.
              <br />13.3. Актуальная версия Политики в свободном доступе расположена в сети Интернет по адресу https://domozmsk.ru/privacy.
              <br />
              <br />
              <p style="text-align: right;"><span style="font-size: 14px;">Обновлено 02.02.2026г</span></p></p>
