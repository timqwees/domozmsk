...
<meta property="og:image" content="[[*article_image:default=`https://domozmsk.ru/assets/img/og-cover.jpg`]]">
...
<meta name="twitter:image" content="[[*article_image:default=`https://domozmsk.ru/assets/img/og-cover.jpg`]]">

<!-- === AI & DISCOVERY === -->
<link rel="ai-content" href="https://domozmsk.ru/llms.txt" type="text/plain" title="LLMs.txt — AI-readable site index">

<!-- === FAVICONS === -->
<link rel="icon" type="image/png" href="https://domozmsk.ru/assets/img/favicon/favicon-96x96.png" sizes="96x96">
...
<link rel="apple-touch-icon" sizes="180x180" href="https://domozmsk.ru/assets/img/favicon/apple-touch-icon.png">
...
<!-- ЭТА ОДНА СТРОКА ЗАМЕНЯЕТ ВСЕ ВАШИ СТАРЫЕ ЧАНКИ: createPerson, schemaOrganization, schemaArticle, schemaWebPage -->
[[!SchemaBlogPosting]]
